	...
	<form id="searchForm" method="post">
		<table>
			<tr>
				...
				<td><input name="filter_EQS_paramCd" type="text" value="${filter_LIKES_paramCd}"></input></td>
				...
				<td><s:select list="@com.powerlong.plas.utils.DictMapUtil@getMapEnableFlgNum()" name="filter_EQS_defaultFlg" listKey="key" listValue="value"/></td>
