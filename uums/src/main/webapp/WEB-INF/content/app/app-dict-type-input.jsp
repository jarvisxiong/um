	...
	$(function(){
		$('#tt2').datagrid({
			columns:[[
				...
				{field:'dictLevelNum',title:'级别',align:'right',width:50,editor:{type:'validatebox',options:{required:'true',validType:'length[1,10]'}}},
				{field:'sequenceNo',title:'显示序号',align:'right',width:60,editor:{type:'numberbox',options:{max:'10'}}},
