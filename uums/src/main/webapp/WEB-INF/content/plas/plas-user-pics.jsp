...
<div style="line-height:25px;height:25px;">请上传指定格式的图片(例如:jpg格式)</div>
<div>
	<s:if test="picAttas!= null && picAttas.size>0">
		...
		<a id="big_img_box" class="MagicZoomPlus" target="_blank" href="javascript:window.open('${pic}')"><img src="${pic}"  style="height:120px;" /></a>
	</s:if>
	<s:else>
		<a id="big_img_box" class="MagicZoomPlus" target="_blank" href="${ctx}/images/user_default_photo.jpg"><img src="${ctx}/images/user_default_photo.jpg"  style="height:120px;" /></a>
	</s:else>
</div>
<%--
