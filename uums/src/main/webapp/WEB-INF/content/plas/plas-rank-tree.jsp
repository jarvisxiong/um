...
<%@ include file="/common/taglibs.jsp" %>  	<!-- TreePanel机构树 -->
	<link   href="${ctx}/css/common/treePanel.css" type="text/css" rel="stylesheet"/>
	<script src="${ctx}/js/common/common.js" type="text/javascript"></script>
	<script src="${ctx}/js/common/treePanel.js"  type="text/javascript" ></script>

<script src="${ctx}/js/plugins/loadMask/jquery.loadmask.min.js"  type="text/javascript" ></script>
