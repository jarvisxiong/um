...
function PasswordStrength(showed){	
	...
	this.styles[3] = {backgroundColor:"#6AB36A",borderLeft:"solid 1px #FFFFFF",borderRight:"solid 1px #3BBC1B",borderBottom:"solid 1px #3BBC1B"};
...
PasswordStrength.prototype.init = function(){
	...
	s += '<tr>';
	for(var i=0;i<3;i++){
		s += '<td id="'+this.divName+'_td_'+i+'" width="33.3%" align="center"><span style="font-size:1px">&nbsp;</span><span id="'+this.divName+'_label_'+i+'" style="display:none;font-family: Courier New, Courier, mono;font-size: 12px;color: #000000;">'+this.labels[i]+'</span></td>';
	}	
	s += '</tr>';
	s += '</table>';
	this.content = s;
...
//1-弱 2-中 3-强
PasswordStrength.prototype.getSelectedIndex = function(s){
