var pdWindow = {
    ...
    createNewWindow : function(title, width, height) {
        ...
        newWindowContent += '<div class="window-minimizeButton">-</div>';
        newWindowContent += '<div class="window-maximizeButton">O</div>';
        newWindowContent += '<div class="window-closeButton">X</div>';
        newWindowContent += '</div>';
        newWindowContent += '<div class="window-content"></div>';
        newWindowContent += '<div class="window-statusBar">';
        newWindowContent += '<div class="window-resizeIcon">#</div>';
        newWindowContent += '</div>';
        ...
        //methods
        oElem.titleBar.onmousedown = pdWindow._dragBegin;
        oElem.resizeIcon.onmousedown = pdWindow._resizeBegin;
        oElem.minimize = function(){pdWindow._minimize(this);};
        oElem.maximize = function(){pdWindow._maximize(this);};
        oElem.close = function(){pdWindow._close(this);};
        oElem.minimizeButton.onclick = function(){pdWindow._minimize(this._parent);};
        oElem.maximizeButton.onclick = function(){pdWindow._maximize(this._parent);};
        oElem.closeButton.onclick = function(){pdWindow._close(this._parent);};
        oElem.setFocus = function(){pdWindow._setFocus(this);};
        oElem.move = function(x,y,savePosition){pdWindow._move(this,x,y,savePosition);};
        oElem.resize = function(newWidht,newHeight,saveSize){pdWindow._resize(this,newWidht,newHeight,saveSize);};
        oElem.addContent = function(content){pdWindow._addContent(this,content);};
    ...
    _dragBegin : function(e) {
        var oElem = pdWindow._windowContainer = this._parent;
        ...
        document.onmousemove = pdWindow._dragging;
        document.onmouseup = pdWindow._dragEnd;
        return false;
    },
    ...
    _resizeBegin : function(e) {
        ...
        document.onmousemove = pdWindow._resizing;
        document.onmouseup = pdWindow._resizeEnd;
        return false;
    },


    _dragging : function(e) {
        var oElem = pdWindow._windowContainer;
    ...
    _dragEnd : function() {
        ...
        pdWindow._windowContainer = null;
    },
    ...
    _setFocus : function(oElem){
        pdWindow._zIndex++;
        oElem.style.zIndex = pdWindow._zIndex;
    },
