	...
	function switchProject(srcElem, projectCd){
		...
		$.post(_ctx+'/plan/plan-exec-plan-stat!switchProject.action',data, function(result) {
	...
	function switchOperation(srcElem, projectCd, operationId){
		...
		var planTypeCd = getPlanTypeCd();
		var data = {projectCd: projectCd, operationId : operationId, planTypeCd: planTypeCd};
		$.post(_ctx + "/plan/plan-exec-plan-stat!switchOperation.action", data, function(result) {
	...
	function switchFullScreen(){
		var url = new Array();
		url.push(_ctx+'/plan/plan-exec-plan-stat!portal.action?');
