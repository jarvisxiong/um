...
(function() {
    ...
    function Ea(a, b, c) {
        var d, e;
        if (Pb(b)) if (M(c)) a.setAttribute(b, c);
        else {
            if (a && a.getAttribute) e = a.getAttribute(b)
        } else if (M(b) && Lb(b)) for (d in b) a.setAttribute(d, b[d]);
        return e
    }
    function rc(a) {
    ...
    function Gd(a, b) {
        function c(m, i) {
            ...
            function O(k, o) {
                ...
                if (!o) {
                    o = [1, 2, 2.5, 5, 10];
                    if (i.allowDecimals === false || H) if (Fb === 1) o = [1, 2, 5, 10];
                    else if (Fb <= 0.1) o = [1 / Fb]
                }
            ...
            function Ma() {
                var k, o, r, q, A = i.tickInterval,
                U = i.tickPixelInterval;
                ...
                if (F) {
                    ...
                    if (ba >= G) ia.setSeconds(ba >= V ? 0 : s * kb(ia.getSeconds() / s));
                    ...
                    for (Ba = ia[sc](); G < fa && r < Ca;) {
                        ta.push(G);
                        if (ba === ma) G = Dc(o + r * s, 0) / rb;
                        else if (ba === q) G = Dc(o, V + r * s) / rb;
                        else if (!A && (ba === U || ba === k)) G = Dc(o, V, Ba + r * s * (ba === U ? 1 : 7));
                        else G += ba * s;
                        r++
                    }
                    ta.push(G);
            ...
            function Aa() {
                ...
                if (!v.isDirty) v.isDirty = ca !== Gb || fa !== Ld
            }
            function Qa(k) {
                k = (new x(k)).render();
                Sb.push(k);
            ...
            function Ra() {
                ...
                if (A || Rb) {
                    ...
                    G || u((i.plotLines || []).concat(i.plotBands || []),
                    function(s) {
                ...
                if (o && o.enabled) {
                    var Ba, ma;
                    o = v.stackTotalGroup;
                    if (!o) v.stackTotalGroup = o = ga.g("stack-labels").attr({
                        visibility: Ab,
                        zIndex: 6
                    }).translate(Y, ha).add();
                    for (Ba in t) {
            ...
            Lc,
            Xa = i.categories,
            $d = i.labels.formatter ||
            function() {
                var k = this.value;
                return Lc ? Nc(Lc, k) : Ta % 1E6 === 0 ? k / 1E6 + "M": Ta % 1E3 === 0 ? k / 1E3 + "k": !Xa && k >= 1E3 ? zd(k, 0) : k
            },
            Oc = z && i.labels.staggerLines,
            $b = i.reversed,
            ac = Xa && i.tickmarkPlacement === "between" ? 0.5 : 0;
            y.prototype = {
                addLabel: function() {
                    var k = this.pos,
                    o = i.labels,
                    ...
                    q = pa(q, o.style);
                    if (A === Va) this.label = M(k) && r && o.enabled ? ga.text(k, 0, 0).attr({
                        align: o.align,
                        rotation: o.rotation
                    }).css(q).add(gc) : null;
                    else A && A.attr({
            ...
            x.prototype = {
                render: function() {
                    ...
                    if (A) {
                        ...
                        U = qb(U, fa);
                        G = Tb(U);
                        if ((s = Tb(V)) && G) s.push(G[4], G[5], G[1], G[2]);
                        else s = null;
                        o = {
                            fill: ia
                        }
                    ...
                    if (r && M(r.text) && s && s.length && Ca > 0 && xa > 0) {
                        ...
                        r);
                        if (!q) k.label = q = ga.text(r.text, 0, 0).attr({
            ...
            pa(v, {
                ...
                getOffset: function() {
                    ...
                    if (k || Rb) {
                        u(ta,
                        function(V) {
                            if (tb[V]) tb[V].addLabel();
                            else tb[V] = new y(V);
                            if (Z === 0 || Z === 2 || {
                                1 : "left",
                                3 : "right"
                            } [Z] === A.align) ic = Ha(tb[V].getLabelSize(), ic)
                        });
                        if (Oc) ic += (Oc - 1) * 16
                    } else for (G in tb) {
                        tb[G].destroy();
                    ...
                    if (q && q.text) {
                        if (!v.axisTitle) v.axisTitle = ga.text(q.text, 0, 0).attr({
                            zIndex: 7,
        ...
        function f(m, i) {
            function y(z) {
                var Z, t = Nd && wa.width / wa.documentElement.clientWidth - 1,
                v, N, F;
                z = z || cb.event;
            ...
            Qc = function() {
                ...
                } else m.trackerGroup = Rc = ga.g("tracker").attr({
                    zIndex: 9
                }).add()
            };
            Qc();
            ...
            (function() {
                ...
                ya.onmousedown = function(t) {
                    t = y(t); ! Jb && t.preventDefault && t.preventDefault();
                ...
                var Z = function(t) {
                    if (! (t && t.touches && t.touches.length > 1)) {
                        ...
                        N = t.chartY,
                        F = !kc(v - Y, N - ha);
                        if (Jb && t.type === "touchstart") if (Ea(t.target, "isTracker")) m.runTrackerClick || t.preventDefault();
                        else ! ae && !F && t.preventDefault();
                        if (F) {
                            z || Q();
                            if (v < Y) v = Y;
                            else if (v > Y + Ca) v = Y + Ca;
                            if (N < ha) N = ha;
                            else if (N > ha + xa) N = ha + xa
                        }
                        if (nd && t.type !== "touchstart") {
                            Ma = Math.sqrt(Math.pow(O - v, 2) + Math.pow(ea - N, 2));
                            if (Ma > 10) {
                                if (lc && (Ra || Za) && kc(O - Y, ea - ha)) Aa || (Aa = ga.rect(Y, ha, Ga ? 1 : Ca, Ka ? 1 : xa, 0).attr({
                            ...
                            if (uc && i.shared) {
                                ...
                                for (P = H.length; P--;) H[P]._dist > oa && H.splice(P, 1);
        ...
        function n(m, i) {
            ...
            function(y) {
                ...
                if (y && y.text && !Q) p[x] = ga.text(y.text, 0, 0).attr({
                    align: y.align,
                    "class": "highcharts-" + x,
                    zIndex: 1
        ...
        function aa() {
            ...
            if (!p.seriesGroup) p.seriesGroup = ga.g("series-group").attr({
                zIndex: 3
            }).add();
            u(Ia,
            function(x) {
        ...
        function da() {
            if (!yc && cb == cb.top && wa.readyState !== "complete") wa.attachEvent("onreadystatechange",
            function() {
        ...
        R = w.margin;
        R = Lb(R) ? R: [R, R, R, R];
        var B = C(w.marginTop, R[0]),
        K = C(w.marginRight, R[1]),
        S = C(w.marginBottom, R[2]),
        I = C(w.marginLeft, R[3]),
        za = w.spacingTop,
        Da = w.spacingRight,
        gb = w.spacingBottom,
        wb = w.spacingLeft,
        ...
        be = function(m) {
            ...
            function Q(L) {
                ...
                if (!Ja) {
                    ...
                    L.legendItem = Ja = ga.text(O.labelFormatter.call(L), 0, 0).css(L.visible ? Za: Ka).on("mouseover",
                    function() {
                        L.setState(Bb);
                        Ja.css(Ga)
                    }).on("mouseout",
                    ...
                    if (Fa) ka = ga.rect(T = -Ma - Aa, ra = -11, Ma, 12, 2).attr({
                        zIndex: 3
                    }).add(fb);
                    else if (Oa && Oa.marker && Oa.marker.enabled) ka = ga.symbol(L.symbol, T = -Ma / 2 - Aa, ra = -4, Oa.marker.radius).attr({
                        zIndex: 3
                    }).add(fb);
                    if (ka) {
                        ka.xOff = T + fa % 2 / 2;
            ...
            function na() {
                ...
                if (oa || ua) {
                    Wb += 2 * z;
                    Xb += 2 * z;
                    if ($) Wb > 0 && Xb > 0 && $.animate($.crisp(null, null, null, Wb, Xb));
                    else $ = ga.rect(0, 0, Wb, Xb, O.borderRadius, oa || 0).attr({
            ...
            if (O.enabled) {
                var ea = O.layout === "horizontal",
                Ma = O.symbolWidth,
                Aa = O.symbolPadding,
                Qa, Ra = O.style,
                Za = O.itemStyle,
                Ga = O.itemHoverStyle,
                Ka = O.itemHiddenStyle,
                z = ja(Ra.padding),
                Z = 20,
                t = 18,
                v = 4 + z + Ma + Aa,
        ...
        md = function(m) {
            var i = Wa.lang,
            y = p.pointCount < 100;
            p.toolbar.add("zoom", i.resetZoom, i.resetZoomTitle, Td); ! m || m.resetSelection ? u(db,
            function(x) {
                x.setExtremes(null, null, false, y)
            }) : u(m.xAxis.concat(m.yAxis),
            function(x) {
                var Q = x.axis;
        ...
        vc = function() {
            ...
            if (m.enabled && !m.floating) if (Q === "right") M(K) || (Hb = Ha(Hb, Wb - y + i + Da));
            else if (Q === "left") M(I) || (Y = Ha(Y, Wb + y + i + wb));
            else if (na === "top") M(B) || (ha = Ha(ha, Xb + x + i + za));
            else if (na === "bottom") M(S) || (sb = Ha(sb, Xb - x + i + gb));
            lc && u(db,
            function(ea) {
                ea.getOffset()
            });
        ...
        pd = function() {
            var m = w.borderWidth || 0,
            i = w.backgroundColor,
            y = w.plotBackgroundColor,
            x = w.plotBackgroundImage,
            Q, na = {
                x: Y,
                y: ha,
                width: Ca,
            ...
            Q = m + (w.shadow ? 8 : 0);
            if (m || i) if (Xc) Xc.animate(Xc.crisp(null, null, null, Ya - Q, Ua - Q));
            else Xc = ga.rect(Q / 2, Q / 2, Ya - Q, Ua - Q, w.borderRadius, m).attr({
                stroke: w.borderColor,
                "stroke-width": m,
                fill: i || jb
            }).add().shadow(w.shadow);
            if (y) if (ud) ud.animate(na);
            else ud = ga.rect(Y, ha, Ca, xa, 0).attr({
                fill: y
            }).add().shadow(w.plotShadow);
            if (x) if (vd) vd.animate(na);
            else vd = ga.image(x, Y, ha, Ca, xa).add();
            if (w.plotBorderWidth) if (Yc) Yc.animate(Yc.crisp(null, Y, ha, Ca, xa));
            else Yc = ga.rect(Y, ha, Ca, xa, 0, w.plotBorderWidth).attr({
    ...
    Bc = /msie/i.test(pc) && !cb.opera,
    zc = wa.documentMode === 8,
    Nd = /AppleWebKit/.test(pc),
    Rd = /Firefox/.test(pc),
    yc = !!wa.createElementNS && !!wa.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
    Wc,
    Jb = wa.documentElement.ontouchstart !== undefined,
    Vd = {},
    qd = 0,
    rb = 1,
    Hc,
    ...
    ab = "M",
    La = "L",
    Wd = "rgba(192,192,192," + (yc ? 1.0E-6: 0.0020) + ")",
    hb = "",
    Bb = "hover",
    Dc,
    bd,
    ...
    Ic.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (Pb(a)) {
                ...
                if (c === "d") {
                    ...
                    if (this.rotation) Ea(g, "transform ", "rotate(" + this.rotation + " " + d + " " + ja(a.y || Ea(g, "y")) + ")")
        ...
        updateTransform: function() {
            ...
            //if (a || b) e.push("alert(x=" + this.translateX + ",y=" + this.translateY + "+")");
            ...
            function(E, da) {
                ...
                function(K) {
                    if (K !== "" || w.length === 1) {
                        ...
                        if (!R) {
                            if (da) { ! yc && a.renderer.forExport && Na(I, {
                                    display: "block"
                                });
            ...
            attr: function(a, b) {
                ...
                if (Pb(a)) {
                    ...
                    if (l && /^(x|y|r|start|end|width|height|innerR)/.test(c)) {
                        ...
                        this[c] = d;
                        if (dc(d)) d += bb
                    } else if (c === "dashstyle") { (f.getElementsByTagName("stroke")[0] || ib(j.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid";
                        this.dashstyle = d;
                        n = true
        ...
        la.prototype = va(Vc.prototype, {
            ...
            symbols: {
                arc: function(a, b, c, d) {
                    ...
                    J = d && 0.1 / d || 0;
                    if (f - e === 0) return ["x"];
                    else if (2 * cc - f + e < n) j = -n;
                    else if (f - e < J) j = nb(e + J);
    ...
    Ac.prototype = {
        ...
        applyOptions: function(a) {
            ...
            if (this.x === Va) this.x = b.autoIncrement()
        },
        destroy: function() {
            var a = this,
            b = a.series,
    ...
    pb.prototype = {
        ...
        setTooltipPoints: function(a) {
            ...
            c = b.inverted,
            d = [],
            e = X((c ? b.plotTop: b.plotLeft) + b.plotSizeX),
            f,
            g,
            h = [];
        ...
        drawPoints: function() {
            ...
            if (this.options.marker.enabled) for (f = b.length; f--;) {
                ...
                if (e !== Va && !isNaN(e)) {
                    ...
                    else g.graphic = c.renderer.symbol(C(g.marker && g.marker.symbol, this.symbol), d, e, h).attr(a).add(this.group)
                }
            }
        },
        ...
        drawGraph: function() {
            ...
            n,
            J = a.chart.renderer,
            D = a.yAxis.getThreshold(b.threshold || 0),
            aa = /^area/.test(a.type),
            E = [],
            da = [];
            u(a.segments,
            function(w) {
                ...
                u(w,
                function(S, I) {
                    if (a.getPointSpline) n.push.apply(n, a.getPointSpline(w, S, I));
                    else {
                        n.push(I ? La: ab);
                ...
                if (aa) {
                    ...
                    if (b.stacking && a.type !== "areaspline") for (B = w.length - 1; B >= 0; B--) R.push(w[B].plotX, w[B].yBottom);
                    else R.push(La, w[w.length - 1].plotX, D, La, w[0].plotX, D);
                    da = da.concat(R)
                }
            });
            a.graphPath = d;
            ...
            if (aa) {
                ...
                else a.area = a.chart.renderer.path(da).attr({
                    fill: e
                }).add(g)
            }
            if (c) c.animate({
    ...
    var ad = yb(pb, {
        ...
        translate: function() {
            ...
            function(S) {
                ...
                gb = fd(qb(I, za)),
                wb = fd(Ha(I, za) - gb),
                Ob = a.yAxis.stacks[(S.y < 0 ? "-": "") + a.stackKey],
                Kb;
                ...
                S.shapeType = "rect";
                I = pa(b.renderer.Element.prototype.crisp.apply({},
                [e, Da, gb, w, wb]), {
                    r: c.borderRadius
                });
                if (e % 2) {
    ...
    la = yb(pb, {
        ...
        drawPoints: function() {
            ...
            function(j) {
                ...
                if (d) d.animate(h);
                else j.graphic = b.arc(h).attr(pa(j.pointAttr[hb], {
        ...
        drawDataLabels: function() {
            ...
            e = C(d.connectorPadding, 10),
            f = C(d.connectorWidth, 1),
            g,
            h,
            j = d.distance,
            l = this.radiusY,
            ...
            if (d.enabled) {
                ...
                for (a = D[0][0] && D[0][0].dataLabel && ja(D[0][0].dataLabel.styles.lineHeight); R--;) {
                    ...
                    for (B = 0; B < za; B++) {
                        ...
                        if (Da < B && K[B] !== null) Da = B;
                        else if (da < za - B + Da && K[B] !== null) Da = da - za + B;
                        else for (; K[Da] === null;) Da++;
                        S.push({
                            i: Da,
                            y: K[Da]
                        });
