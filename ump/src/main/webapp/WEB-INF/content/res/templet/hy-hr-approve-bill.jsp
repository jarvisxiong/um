...
<div align="center" class="billContent">
	...
	<form action="res-approve-info!save.action" method="post" id="templetForm" class="contractPaymentBill">
		...
		<table  class="mainTable">
			...
			<col width="200">
			<tr>
			<td><s:checkbox name="templateBean.adjustItem1" cssClass="group"></s:checkbox>新聘</td>
			...
			<tr>
			<td><s:checkbox name="templateBean.adjustItem7" cssClass="group"></s:checkbox>奖励</td>
			<td><s:checkbox name="templateBean.adjustItem8" cssClass="group"></s:checkbox>处罚</td>
			<td><s:checkbox name="templateBean.adjustItem9" cssClass="group"></s:checkbox>辞退</td>
			<td><s:checkbox name="templateBean.adjustItem10" cssClass="group"></s:checkbox>其他
		...
		<table  class="mainTable" cellpadding="0" cellspacing="0" style="border-top: none; ">
			...
			<tr>
			<td class="td_title">工资(元)</td>
			<td><input class="inputBorder" validate="required" type="text" name="templateBean.salaryBefore" onblur="formatVal($(this));" value="${templateBean.salaryBefore}"/></td>
			<td><input class="inputBorder" validate="required" type="text" name="templateBean.salaryAfter" onblur="formatVal($(this));" value="${templateBean.salaryAfter}"/></td>
			</tr>
			<tr>
