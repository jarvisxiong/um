...
<%@ include file="/common/taglibs.jsp"%>
		...
		<table  class="mainTable">
			...
			<tr>
				...
				<td style="border-top: none;">
				 <input id="centerName" validate="required" type="text" name="templateBean.centerName" value="${templateBean.centerName}" readonly="readonly" <s:if test="#isMy==1"> class="inputBorderNoTip orgSelect" style="cursor: pointer;" </s:if ><s:else> class="inputBorderNoTip" </s:else>/>
