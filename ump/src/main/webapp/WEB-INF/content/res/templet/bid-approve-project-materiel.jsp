...
<div align="center" class="billContent">
	...
	<form action="res-approve-info!save.action" method="post" id="templetForm" class="contractPaymentBill">
		...
		<table  class="mainTable">
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" class="tb_noborder">
						...
						<s:else><%--if test="authTypeCd == 'BLSY_ZCGL_DB_20'||authTypeCd=='BLSY_ZCGL_DB_30'||authTypeCd=='BLSY_ZCGL_DB_40'||authTypeCd=='BLSY_ZCGL_DB_50'||authTypeCd=='BLSY_ZCGL_DB_60'||authTypeCd=='BLSY_ZCGL_DB_70'" --%>
				...
				<%--		<s:if test="authTypeCd == 'ZCGL_HTQS_30'||authTypeCd == 'BLSY_ZCGL_DB_20'||authTypeCd=='BLSY_ZCGL_DB_30'||authTypeCd=='BLSY_ZCGL_DB_40'||authTypeCd=='BLSY_ZCGL_DB_50'||authTypeCd=='BLSY_ZCGL_DB_60'||authTypeCd=='BLSY_ZCGL_DB_70'">
					 --%>
						<input validate="required" type="text" name="templateBean.projectName" value="${templateBean.projectName}" id="projectName"  <s:if test="#isMy==1"> class="inputBorderNoTip " style="cursor: pointer;" </s:if ><s:else> class="inputBorderNoTip" </s:else>/>
			...
			<s:if test="authTypeCd=='BLSY_ZCGL_DB_20'||authTypeCd=='BLSY_ZCGL_DB_30'||authTypeCd=='BLSY_ZCGL_DB_40'||authTypeCd=='BLSY_ZCGL_DB_70'||authTypeCd=='SYGS_ZCGL_DB_40'">
			<tr>
				<td class="td_title require"></td>
			...
			<tr>
				<td class="td_title" rowspan="4">定标资料附件<br/>(请作为附件上传)</td>
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.bidQualificationApproveId}">1、邀标单位资质审批表</td>
				<td align="center">
			...
			<tr>
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.bidPriceListId}">2、中标单位报价清单</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
			...
			<tr>
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.bidSummaryId}">3、投标报价汇总表</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
			...
			<tr>
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.bidAnswerAndBidQueryId}">4、技术参数或图片</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
				<input type="button" value="上传附件" class="btn_green_65_20" style="border:none;" onclick="showUploadSingleAttachDialog('技术参数或图片','${resApproveInfoId==null?entityTmpId:resApproveInfoId}','resCustomFile','bidAnswerAndBidQueryId',event);"/>
			...
			<tr>
				...
				<td>
				<input class="inputBorder" <s:if test="statusCd==2 && userCd==#curUserCd && !isImported"> edit='true' validate="required" onblur="contNoValidate(this);"</s:if> type="text" id="contractNo" name="templateBean.contractNo" value="${templateBean.contractNo}"/>
				</td>
			</tr>
			</s:if>
		</table>
