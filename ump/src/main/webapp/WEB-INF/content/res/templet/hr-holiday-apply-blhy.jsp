	...
	<form action="res-approve-info!save.action" method="post" id="templetForm">
		<table  class="mainTable" style="margin-bottom: 5px;">
			...
			<table class="tb_checkbox">
				...
				<col width="150">
				<tr>
				<td><s:checkbox name="templateBean.positionLevel3" cssClass="group"></s:checkbox>副总裁</td>
				<td><s:checkbox name="templateBean.positionLevel1" cssClass="group"></s:checkbox>部门负责人</td>
