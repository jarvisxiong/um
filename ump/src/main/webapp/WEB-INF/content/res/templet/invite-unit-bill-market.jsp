				...
				<table  class="mainTable">
					...
					<tr>
						...
						<td  class="chkGroup"  validate="required" >
							<s:checkbox name="templateBean.overAllYes" id="overAllYes" cssClass="group"></s:checkbox>总包
							<s:checkbox name="templateBean.overAllNo" id="overAllNo" cssClass="group"></s:checkbox>非总包
						</td>
						 //TODO:投标台账启用后,打开  --%>
