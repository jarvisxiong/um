		...
		<tr>
		 ...
		 <td class="chkGroup" align="left"  validate="required">
				<table class="tb_checkbox">
					...
					<col width="150">
					<tr>
					<td><s:checkbox name="templateBean.fileTypeByYear"  cssClass="group"></s:checkbox>年度工作计划</td>
					<td><s:checkbox name="templateBean.fileTypeByMonth"  cssClass="group"></s:checkbox>月度工作计划</td>
					</tr>
				</table>
			</td>
		</tr>
