...
<%@page import="com.hhz.ump.util.DictContants"%><div align="center" class="billContent">
	...
	<form action="res-approve-info!save.action" method="post" id="templetForm" class="contractPaymentBill">
		...
		<table  class="mainTable">
			...
			<col/>
			<tr>
				<td class="td_title">季度回访目的事项</td>
				<td colspan="2">
				<input class="inputBorder" validate="required" type="text" name="templateBean.quarterReturnVisitMatter" value="${templateBean.quarterReturnVisitMatter}" />
				</td>
			</tr>
			<tr>
				<td class="td_title">要求完成时间</td>
				<td colspan="2">
				<input class="inputBorder" validate="required" type="text" onfocus="WdatePicker()" name="templateBean.completeTime" value="${templateBean.completeTime}" style="width:100px;" />
				</td>
			</tr>
			<tr>
				<td class="td_title">此次回访范围</td>
				<td colspan="2">
			...
			<tr>
				...
				<td colspan="2">
				<textarea class="inputBorder contentTextArea" validate="required" name="templateBean.otherDesc">${templateBean.otherDesc}</textarea>
				</td>
			</tr>
			<tr>
