...
<div align="center" class="billContent">
	...
	<form action="res-approve-info!save.action" method="post" id="templetForm" class="contractPaymentBill">
		...
		<table  class="mainTable">
			...
			<s:if test="authTypeCd=='BLSY_ZCGL_DB_20'||authTypeCd=='BLSY_ZCGL_DB_30'||authTypeCd=='BLSY_ZCGL_DB_40'||authTypeCd=='BLSY_ZCGL_DB_70'||authTypeCd=='SYGS_ZCGL_DB_30'">
			<tr>
			...
			<tr>
				<td class="td_title" rowspan="5">定标资料附件<br/>(请作为附件上传)</td>
			...
			<tr>
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.techBidEvaluateId}" resattachname="设备技术参数及规格">5、设备技术参数及规格</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
				<input type="button" value="上传附件" class="btn_green_65_20" style="border:none;" onclick="showUploadSingleAttachDialog('设备技术参数及规格','${resApproveInfoId==null?entityTmpId:resApproveInfoId}','resCustomFile','techBidEvaluateId',event);"/>
