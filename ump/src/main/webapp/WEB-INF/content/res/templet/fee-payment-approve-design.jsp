...
<div align="center" class="billContent">
	...
	<form action="res-approve-info!save.action" method="post" id="templetForm" class="contractPaymentBill">
		...
		<table class="mainTable">
			...
			<tr>
				<td class="td_title">发起中心</td>
				<td colspan="3" class="chkGroup" align="left"  validate="required">
					<table class="tb_checkbox">
					<col width="150">
					<col width="150">
					<tr>
					<td><s:checkbox name="templateBean.sendCenter1"  cssClass="group"></s:checkbox>设计管理中心</td>
					<td><s:checkbox name="templateBean.sendCenter2"  cssClass="group"></s:checkbox>技术研发中心</td>
					</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3" align="left"  validate="required">
					...
					<col width="150">
					<tr>
					<td><s:checkbox name="templateBean.payDependence1"  cssClass="group"></s:checkbox>设计成果审批表</td>
					<td><s:checkbox name="templateBean.payDependence2"  cssClass="group"></s:checkbox>图纸签收表</td>
					</tr>
					<tr>
					<td><s:checkbox name="templateBean.payDependence3"  cssClass="group"></s:checkbox>白皮书</td>
					<td><s:checkbox name="templateBean.payDependence4"  cssClass="group"></s:checkbox>材料封样</td>
					</tr>
					</table>
				</td>
			</tr>
			...
			<s:if test="authTypeCd=='JD_CWGL_60'">
			<tr>
				<td class="td_title" rowspan="2">附件上传</td>
				<td align="center" style="height:40px;" validate="required" value="${templateBean.payDependenceId}">设计成果审批表</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
				<input type="button" value="上传附件" class="btn_green_65_20" style="border:none;" onclick="showUploadSingleAttachDialog('设计成果审批表','${resApproveInfoId==null?entityTmpId:resApproveInfoId}','resCustomFile','payDependenceId',event);"/>
			...
			<tr>
			<td align="center" style="height:40px;" validate="required" value="${templateBean.blueprintSignSheet}">图纸签收表</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
				<input type="button" value="上传附件" class="btn_green_65_20" style="border:none;" onclick="showUploadSingleAttachDialog('图纸签收表','${resApproveInfoId==null?entityTmpId:resApproveInfoId}','resCustomFile','blueprintSignSheet',event);"/>
				<input type="hidden" name="templateBean.blueprintSignSheet" id="blueprintSignSheet" value="${templateBean.blueprintSignSheet}"/>
				</s:if>
				</td>
				<td>
				<div id="show_blueprintSignSheet"></div>
				<script type="text/javascript">
				showUploadedFile('${templateBean.blueprintSignSheet}','blueprintSignSheet','${canEdit}');
				</script>
				</td>
			</tr>
			</s:if>
...
function getCont(id){
	...
	if(parent.TabUtils==null)
	  ...
	  parent.TabUtils.newTab("cont-ledger-input","台账查看",url,true);
}
...
<script type="text/javascript">
	...
	var mapPrama={
		...
		currentRealPay:'currentPayBefore'
	};
