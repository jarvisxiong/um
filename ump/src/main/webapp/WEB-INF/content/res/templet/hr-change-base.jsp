...
<div align="center" class="billContent">
				...
				<table  class="mainTable">
					...
					<col width="200">
					<tr>
					<td><s:checkbox name="templateBean.adjustItem4" popupValue="请上传\"人员简历\"" cssClass="group"></s:checkbox>降职</td>
					<td><s:checkbox name="templateBean.adjustItem2" popupValue="请上传各月\"试用期工作总结\"、\"面谈记录表\"和\"月度考核表\"" cssClass="group"></s:checkbox>通过试用期</td>
					<td><s:checkbox name="templateBean.adjustItem3" popupValue="请上传\"人员简历\"" cssClass="group"></s:checkbox>升职</td>
					<td></td>
					</tr>
					<tr>
					<td><s:checkbox name="templateBean.adjustItem5" popupValue="" cssClass="group"></s:checkbox>内部调动</td>
					<td><s:checkbox name="templateBean.adjustItem6" popupValue="" cssClass="group"></s:checkbox>工资变动</td>
					<td><s:checkbox name="templateBean.adjustItem8" popupValue="" cssClass="group"></s:checkbox>临时借调</td>
					<td><s:checkbox name="templateBean.adjustItem12" popupValue="主动离职，请上传《辞职申请报告》；s被动离职，请上传《员工调岗培训或辞退建议表》、《考核表》" cssClass="group"></s:checkbox>离职</td>
					</tr>
					<tr>
					<td><s:checkbox name="templateBean.adjustItem11" popupValue="请上传\"人员简历\"、\"职位申请表\"" cssClass="group"></s:checkbox>新聘</td>
					<td><s:checkbox name="templateBean.adjustItem9" popupValue="" cssClass="group"></s:checkbox>奖励</td>
					<td><s:checkbox name="templateBean.adjustItem10" popupValue="" cssClass="group"></s:checkbox>惩罚</td>
					<td colspan="2"><s:checkbox name="templateBean.adjustItem7" popupValue="" cssClass="group"></s:checkbox>其他
		...
		<script>
		//alert("主动离职，请上传《辞职申请报告》；\n被动离职，请上传《员工调岗培训或辞退建议表》、《考核表》");
		//对有popupValue属性的checkbox加上点击事件
		$("[popupValue]").each(function(){
			var obj = $(this);
				obj.click(function(){
					if(obj.attr("checked") == true){
						if($.trim(obj.attr("popupValue")) != ""){
							alert(obj.attr("popupValue").replace("s","\n"));
						}
						$("#alertShow").html(obj.attr("popupValue").replace("s","<br/>")).css("color","red");
					}else{
						$("#alertShow").html("");
					}
