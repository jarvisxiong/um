...
<div align="center" class="billContent">
	...
	<form action="res-approve-info!save.action" method="post" id="templetForm" class="contractPaymentBill">
		...
		<table  class="mainTable">
			...
			<tr>
				<td colspan="3" style="padding-top:3px;">
					<table border="0" cellpadding="0" cellspacing="0" class="tb_noborder">
						...
						<td>
						<input class="inputBorder" validate="required" type="text" id="totalDay" name="templateBean.totalDay" value="${templateBean.totalDay}" onblur="formatVal($(this));" resContLedField="totalDay"/>
						</td>
						<td>天</td>
						</tr>
					</table>
			...
			<tr>
				<td class="td_title" rowspan="2">定标资料附件<br/>(请作为附件上传)</td>
			...
			<tr>
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.bidAnswerAndBidQueryId}" resattachname="预算审批表">2、预算审批表</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
