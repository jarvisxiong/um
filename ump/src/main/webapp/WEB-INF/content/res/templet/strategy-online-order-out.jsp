...
<s:if test="templateBean.strategyMatePrices.size()>0">
	...
	<%--战略内记录总数 --%>
	<s:set name="strageOutCount">0</s:set>
	
	<%-- 当前类型行数 --%>
	<s:set name="moduleRowCount">0</s:set>
	
	<s:iterator value="templateBean.strategyMatePrices">
		<s:set name="curCostMateId">${costMateId}</s:set>
		
		<s:if test="strageTypeCd == 2">
			
			<%-- 总记录数累加 --%>
			<s:set name="strageOutCount">${strageOutCount+1}</s:set>
			<%-- 当前类型累加 --%>
			...
			<s:else>
				...
				<tr class="mainTr" headFlg='0' costmatepriceid="${costMatePriceId}" costmateid="${costMateId}" inoutflg="2">
					...
					<s:if test="f01 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f01" value="${f01}"/>
								<input type="hidden" fname="h01" value="${h01}"/>
								<input type="hidden" fname="e01" value="${e01}"/>
							</td>
							<s:if test="p01 != null && p01 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p01" value="${p01}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f02 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f02" value="${f02}"/>
								<input type="hidden" fname="h02" value="${h02}"/>
								<input type="hidden" fname="e02" value="${e02}"/>
							</td>
							<s:if test="p02 != null && p02 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p02" value="${p02}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f03 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f03" value="${f03}"/>
								<input type="hidden" fname="h03" value="${h03}"/>
								<input type="hidden" fname="e03" value="${e03}"/>
							</td>
							<s:if test="p03 != null && p03 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p03" value="${p03}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f04 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f04" value="${f04}"/>
								<input type="hidden" fname="h04" value="${h04}"/>
								<input type="hidden" fname="e04" value="${e04}"/>
							</td>
							<s:if test="p04 != null && p04 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p04" value="${p04}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f05 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f05" value="${f05}"/>
								<input type="hidden" fname="h05" value="${h05}"/>
								<input type="hidden" fname="e05" value="${e05}"/>
							</td>
							<s:if test="p05 != null && p05 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p05" value="${p05}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f06 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f06" value="${f06}"/>
								<input type="hidden" fname="h06" value="${h06}"/>
								<input type="hidden" fname="e06" value="${e06}"/>
							</td>
							<s:if test="p06 != null && p06 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p06" value="${p06}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f07 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f07" value="${f07}"/>
								<input type="hidden" fname="h07" value="${h07}"/>
								<input type="hidden" fname="e07" value="${e07}"/>
							</td>
							<s:if test="p07 != null && p07 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p07" value="${p07}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f08 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f08" value="${f08}"/>
								<input type="hidden" fname="h08" value="${h08}"/>
								<input type="hidden" fname="e08" value="${e08}"/>
							</td>
							<s:if test="p08 != null && p08 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p08" value="${p08}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f09 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f09" value="${f09}"/>
								<input type="hidden" fname="h09" value="${h09}"/>
								<input type="hidden" fname="e09" value="${e09}"/>
							</td>
							<s:if test="p09 != null && p09 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p09" value="${p09}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f10 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f10" value="${f10}"/>
								<input type="hidden" fname="h10" value="${h10}"/>
								<input type="hidden" fname="e10" value="${e10}"/>
							</td>
							<s:if test="p10 != null && p10 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p10" value="${p10}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f11 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f11" value="${f11}"/>
								<input type="hidden" fname="h11" value="${h11}"/>
								<input type="hidden" fname="e11" value="${e11}"/>
							</td>
							<s:if test="p11 != null && p11 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p11" value="${p11}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f12 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f12" value="${f12}"/>
								<input type="hidden" fname="h12" value="${h12}"/>
								<input type="hidden" fname="e12" value="${e12}"/>
							</td>
							<s:if test="p12 != null && p12 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p12" value="${p12}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f13 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f13" value="${f13}"/>
								<input type="hidden" fname="h13" value="${h13}"/>
								<input type="hidden" fname="e13" value="${e13}"/>
							</td>
							<s:if test="p13 != null && p13 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p13" value="${p13}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f14 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f14" value="${f14}"/>
								<input type="hidden" fname="h14" value="${h14}"/>
								<input type="hidden" fname="e14" value="${e14}"/>
							</td>
							<s:if test="p14 != null && p14 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p14" value="${p14}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f15 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f15" value="${f15}"/>
								<input type="hidden" fname="h15" value="${h15}"/>
								<input type="hidden" fname="e15" value="${e15}"/>
							</td>
							<s:if test="p15 != null && p15 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p15" value="${p15}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f16 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f16" value="${f16}"/>
								<input type="hidden" fname="h16" value="${h16}"/>
								<input type="hidden" fname="e16" value="${e16}"/>
							</td>
							<s:if test="p16 != null && p16 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p16" value="${p16}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f17 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f17" value="${f17}"/>
								<input type="hidden" fname="h17" value="${h17}"/>
								<input type="hidden" fname="e17" value="${e17}"/>
							</td>
							<s:if test="p17 != null && p17 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p17" value="${p17}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f18 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f18" value="${f18}"/>
								<input type="hidden" fname="h18" value="${h18}"/>
								<input type="hidden" fname="e18" value="${e18}"/>
							</td>
							<s:if test="p18 != null && p18 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p18" value="${p18}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f19 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f19" value="${f19}"/>
								<input type="hidden" fname="h19" value="${h19}"/>
								<input type="hidden" fname="e19" value="${e19}"/>
							</td>
							<s:if test="p19 != null && p19 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p19" value="${p19}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f20 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f20" value="${f20}"/>
								<input type="hidden" fname="h20" value="${h20}"/>
								<input type="hidden" fname="e20" value="${e20}"/>
							</td>
							<s:if test="p20 != null && p20 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p20" value="${p20}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f21 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f21" value="${f21}"/>
								<input type="hidden" fname="h21" value="${h21}"/>
								<input type="hidden" fname="e21" value="${e21}"/>
							</td>
							<s:if test="p21 != null && p21 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p21" value="${p21}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f22 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f22" value="${f22}"/>
								<input type="hidden" fname="h22" value="${h22}"/>
								<input type="hidden" fname="e22" value="${e22}"/>
							</td>
							<s:if test="p22 != null && p22 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p22" value="${p22}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f23 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f23" value="${f23}"/>
								<input type="hidden" fname="h23" value="${h23}"/>
								<input type="hidden" fname="e23" value="${e23}"/>
							</td>
							<s:if test="p23 != null && p23 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p23" value="${p23}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f24 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f24" value="${f24}"/>
								<input type="hidden" fname="h24" value="${h24}"/>
								<input type="hidden" fname="e24" value="${e24}"/>
							</td>
							<s:if test="p24 != null && p24 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p24" value="${p24}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f25 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f25" value="${f25}"/>
								<input type="hidden" fname="h25" value="${h25}"/>
								<input type="hidden" fname="e25" value="${e25}"/>
							</td>
							<s:if test="p25 != null && p25 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p25" value="${p25}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f26 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f26" value="${f26}"/>
								<input type="hidden" fname="h26" value="${h26}"/>
								<input type="hidden" fname="e26" value="${e26}"/>
							</td>
							<s:if test="p26 != null && p26 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p26" value="${p26}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f27 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f27" value="${f27}"/>
								<input type="hidden" fname="h27" value="${h27}"/>
								<input type="hidden" fname="e27" value="${e27}"/>
							</td>
							<s:if test="p27 != null && p27 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p27" value="${p27}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f28 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f28" value="${f28}"/>
								<input type="hidden" fname="h28" value="${h28}"/>
								<input type="hidden" fname="e28" value="${e28}"/>
							</td>
							<s:if test="p28 != null && p28 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p28" value="${p28}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f29 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f29" value="${f29}"/>
								<input type="hidden" fname="h29" value="${h29}"/>
								<input type="hidden" fname="e29" value="${e29}"/>
							</td>
							<s:if test="p29 != null && p29 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p29" value="${p29}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					<s:if test="f30 != null">
						...
						<s:else>
							<td>
								<input type="text" class="inputBorder"  fname="f30" value="${f30}"/>
								<input type="hidden" fname="h30" value="${h30}"/>
								<input type="hidden" fname="e30" value="${e30}"/>
							</td>
							<s:if test="p30 != null && p30 != ''">
								<td>
									<input type="text" class="inputBorder"  fname="p30" value="${p30}"/>
								</td>
							</s:if>
						</s:else>
					</s:if>
					...
					<td>
						<s:if test="headFlg ==0 ">
							<input type="text" fname="cgPrice" class="inputBorder required" validate="required"  value="${cgPrice}" style="width:100%;text-align: right;"/>
						</s:if>
						<s:else>${cgPrice}<input type="hidden" fname="cgPrice" value="${cgPrice}"/></s:else>
					</td>
					<td style="width:80px;text-align: center;">
						<s:if test="headFlg ==0 ">
							<input type="text" fname="buyNum" class="inputBorder required" validate="required"  value="${buyNum}" style="width:100%;text-align: center;"/>
						</s:if>
						<s:else>${buyNum}<input type="hidden" fname="buyNum" value="${buyNum}"/></s:else>
					</td>
					<td class="totalOption" style="width:80px;text-align: center;">
						<s:if test="headFlg == 1">
							<div>小计(元)</div>
