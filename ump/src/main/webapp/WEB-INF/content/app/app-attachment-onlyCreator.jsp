...
<script type="text/javascript">
	...
	function submitAttachment(){
		...
		$("#mainForm").ajaxSubmit(function(result){
			...
			document.location = _ctx + "/app/app-attachment.action?bizModuleCd=${bizModuleCd}&bizEntityId=${bizEntityId}&filterType=${filterType}&bizEntityName=${bizEntityName}&attachModelType=${attachModelType}&onlyCreator=onlyCreator";
		});
	}
</script>
</body>
