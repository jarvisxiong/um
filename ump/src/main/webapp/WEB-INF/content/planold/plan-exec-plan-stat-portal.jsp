...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${ctx}/resources/css/planold/plan-exec-plan-stat.css" />
		...
		<script type="text/javascript" src="${ctx}/resources/js/planold/plan-exec-plan-stat.js"></script>
