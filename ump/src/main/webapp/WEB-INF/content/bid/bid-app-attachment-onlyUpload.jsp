...
<script type="text/javascript">
	...
	function submitAttachment(){
		...
		$("#mainForm").ajaxSubmit(function(result){
			...
			document.location = _ctx + "/bid/bid-app-attachment.action?bizModuleCd=${bizModuleCd}&bizEntityId=${bizEntityId}&filterType=${filterType}&bizEntityName=${bizEntityName}&attachModelType=${attachModelType}&onlyUpload=1";
		});
	}
</script>
</body>
