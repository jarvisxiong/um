...
<table>
	...
	<tr>
		<td>
			<div id="floor1" value="1" style="float:left; width:150px; height:110px; cursor:pointer; background-color: #464646;background-image: url('${ctx}/resources/images/bis/${floorUrl}');" 
				<security:authorize ifAnyGranted="A_PLAN_QUERY">onclick="toBisTenant('${bisFloorId}');"</security:authorize>
				<security:authorize ifNotGranted="A_PLAN_QUERY">title="未分配权限"</security:authorize>
				>
			</div>
		</td>
		<td rowspan="2"></td>
		...
		<table class="tb_content" style="color:#5a5a5a;">
			...
			<col />
			<tr>
				<td class="td_title_border">面积：</td>
				<td >
				<s:if test="square != null">
				${square}㎡
				</s:if>&nbsp;
				</td>
			</tr>
