...
<form action="${ctx }/bis/bis-fact!list.action" id="searchForm" method="post">
	<input type="hidden" id="statusCd" name="statusCd" value="2"/>
	<input type="hidden" id="mustclickId" name="mustclick" value="0"/>
	<div id="header">
		<div class="title_bar" >
			<h2>商业应收明细</h2>
			<div class="left">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;项目：
				<input type="text" id="bisProjectName" name="bisProjectName" value="${bisProjectName}" style="cursor: pointer;color: #ff0000;" readonly="true"/>
				...
				<col />
					<tr class="no_advances_dime">
						...
						<td align="right" class="must_dime" id="must_1" must="true" style="display:none" width="80px">
							<input class=input" type="text" onfocus="WdatePicker()" name="mustInBegin"
								id="mustInBegin" style="cursor: pointer;width:50px;height:16px;margin-top: 2px;"/>
						</td>
						<td align="right" class="must_dime" must="true" style="display:none" width="30">至 &nbsp;</td>
						<td align="right" class="must_dime" id="must_1" must="true" style="display:none" width="80px">
						<input class=input" type="text" onfocus="WdatePicker()" name="mustInEnd"
							id="mustInEnd" style="cursor: pointer;width:70px;height:16px;margin-top: 2px;"/>
						</td>
						<td style="padding-left: 5px;">
							<input id="btn_search" type="button" style="width:65px" class="btn_blue" onclick="return chargeDetailQuery();" value="搜索"/>
							<input type="button" class="btn_blue" value="新增实收" onclick="bisMustNewAdd()"/>
							<input type="button" class="btn_green" onclick="doExport4Search('must');" value="导出"/>
							<input type="button" class="btn_green" style="width:85px !important" value="自动生成实收" id="btn_autoIncome" onclick="doOperateType(this);" name="insert" title="默认应收数额为实收金额，当前系统日期为实收日期" />
				...
				<tr>
					<td colspan="12">
						<ul id="bis_rpt"  style="margin-left: 4px;list-style-type:none;">
							...
							<div id="pageDivTo" style="float:left;"></div>
						<ul class="must_dime"  style="    list-style-type: none;" id="search_due">
							<li id="dueli"  valu='1' >未收齐</li>
							<li id="nodueli"  valu='0' >已收齐</li>
							<li id="allnodueli"  valu='2' style="color:red">全部</li>
							<li id=""  valu='n' style="color:#000">快速搜索:</li>
						</ul>
...
<div id="addContent" style="display:none;clear:both;height:150px;margin:0px;padding:5px;border-bottom:1px solid #dddbdc;background: #E4E7EC;"></div>
