...
<div style="padding-left: 10px; height: 30px; line-height:30px; border: 1px solid #eeeeee; overflow: hidden; white-space: nowrap;">
	<table style="overflow: hidden; white-space: nowrap; width: 100%;">
		<tr>
			...
			<s:else>
			<td width="70px;"><span style="font-weight: bold;">正在查看：</span></td>
			</s:else>
			<td width="40px;">商铺：</td>
	...
	<table class="content_table" >
		...
		<s:else>
			...
			<tr class="mainTr" >	
				...
				<td class="pd-chill-tip" style="padding-left: 10px; padding-right: 6px;" title="${shopName}" >
					<div class="ellipsisDiv_full" onclick="openShopTab('${bisTenant.bisShopId}');">
					${shopName}
					</div>
				</td>
				<td><s:date name="bisTenant.rentStartDate" format="yy-MM-dd"/>至<s:date name="bisTenant.rentEndDate" format="yy-MM-dd"/></td>
