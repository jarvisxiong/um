...
<!-- //应收1-欠费2-实收3-预收4 -->
	<table class="tb_search" style="    margin-left: 5px;">
		...
		<tr class="no_advances_dime">
			...
			<td  width="100"  >
				<input style="width:100px;height:16px;color:#ccc" title="" id="layOutCdList_v0" required="true" onfocus="clearInput(this);" value="搜索商家/商铺"/>
			...
			<td style="padding-left: 5px;">
				<input id="btn_search" type="button" style="width:65px" class="btn_blue" onclick="submitSearch1();" value="搜索"/>
				<security:authorize ifAnyGranted="A_FACT_INSERT">
				<input id="btn_new_fact" class="btn_blue fact_dime" type="button" style="width:65px; "  onclick="appendFact();" value="新增"/>
				</security:authorize>
			</td>
		...
		<tr>
			<td colspan="12">
				<ul id="bis_rpt"  style="margin-left: 4px;list-style-type:none;">
					<li   value="2" id="must"  >应收明细</li>
					<li   value="3" id="overdue"  >欠费明细</li>
					<li   value="1" id="fact" >收费历史记录</li>
					<li   value="4" id="advances" >预收明细</li>
				</ul>
				...
				<ul class="must_dime"  style="    list-style-type: none;" id="search_due">
					<li  id="dueli"  valu='1' style="color:red">未收齐</li>
					<li  id="nodueli"  valu='0' >已收齐</li>
					<li  id="allnodueli"  valu='2' >全部</li>
