...
<tr>
	<td width="250px;" valign="top">
		...
		<table style="width:100%;" class="report_table">
			...
			<col />
			<tr class="top_thead">
				<th class="report_table_dbRow" rowspan="2">多经编号</th>
				<th class="report_table_dbRow" rowspan="2">位置区域</th>
		...
		<table id="leftTable" class="report_table">
			...
			<col width="80" />
			<col />
			<s:iterator value="bisMultiReportVos">
			<tr>
				<td class="pd-chill-tip" title="${multiName}" style="border-top: 0;">
					<div class="ellipsisDiv_full" >
					${multiName}
					</div>
				</td>
				<td class="pd-chill-tip" title="${operationArea}" style="border-top: 0;">
					<div class="ellipsisDiv_full" >
					${operationArea}
					</div>
				</td>
	...
	<td valign="top">
		...
		<table id="rightTopTable" class="report_table">
			...
			<tr class="top_thead">
				<s:iterator value="chargeTypeArr" status="s">
				<th colspan="5" style="border-left: 0;"><p:code2name mapCodeName="@com.hhz.ump.util.DictMapUtil@getMapChargeTypeMrpt()" value="chargeTypeArr[#s.index]"/></th>
				</s:iterator>
			</tr>
			<tr class="top_thead">
				<s:iterator value="chargeTypeArr" status="s">
