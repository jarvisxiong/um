...
<div style="padding: 0 10px; margin-top: 10px;">
	<s:form id="inputFileForm" action="company-file!saveFile.action" method="post">
		<div>
		...
		<div>
			跳转路径：<input name="remark" value="${fileEntity.remark}" type="text" style="width: 265px;" />
		</div>
	</s:form>
	...
	<div style="height: 35px; line-height: 35px; text-align: center; background: #EEE;">
		<s:form id="inputUploadAttForm" action="/app/app-attachment!upload.action" enctype="multipart/form-data">
			<input type="hidden" name="bizModuleCd" value="companyFile" />
