...
<s:form id="inputFolderForm" action="company-meeting!saveFolder.action" method="post">
	<input type="hidden" id="folderId" name="folderId" value="${folderEntity.oaMeetingFolderId}" />
	...
	<table style="margin:0 auto; text-align: center;" cellpadding="0" cellspacing="0">
		<colgroup>
		...
		<tr>
			<td align="center" height="40" valign="bottom" colspan="2">
				<div style="width: 150px;">
					...
					<s:if test="folderEntity.oaMeetingFolderId != ''">
