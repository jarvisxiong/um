...
<div style=" overflow-y: auto; overflow-x: hidden;">
	...
	<s:else>
		<s:form id="fileListForm" action="/oa/company-file!fileList.action" method="post">
			...
			<div>
				<table class="file_list_table" cellpadding="0" cellspacing="0">
					<thead>
						<tr class="header">
							<td style="background-image: none;">文件名称</td>
							<td>附件</td>
							<%--
							...
							<td style="width:55px;">创建人</td>
							 --%>
							<security:authorize ifAnyGranted="A_COMPANYFILE_ADMIN">
							<td style="width:100px;margin: 0; padding-left:5px;">操作</td>
							</security:authorize>
						</tr>
					</thead>
