...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${ctx}/resources/css/plan/cost-exec-plan-stat.css" />
		...
		<script type="text/javascript" src="${ctx}/resources/js/plan/cost-exec-plan-stat.js"></script>
	...
	<body>
		...
		<div class="title_bar">
			...
			<div style="float: left;padding-left:5px;font-size: 12px;color: #0167A2;">
				[成本计划]
			</div>
