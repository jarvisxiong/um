		...
		<td valign="top" style="width:273px;">
			<div id="bottomLeftDiv" style="height:350px;overflow: hidden;width:100%;">
				<table id="bottomLeftContent" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td style="padding-left:2px;width: 30px;height:20px;" class="first_column">${node.costProjectNodeRel.nodeCd}</td>
						<td style="padding-left:2px;width:120px;" title="${node.costProjectNodeRel.nodeName}" class="pd-chill-tip"><div style="width: 95%; height: 18px; line-height: 18px; overflow: hidden; text-align: left;">${node.costProjectNodeRel.nodeName}</div></td>
						<td style="padding-left:2px;width:120px;" title="${node.costProjectNodeRel.resOrgName}" class="pd-chill-tip"><div style="width: 95%; height: 18px; line-height: 18px; overflow: hidden; text-align: left;">${node.costProjectNodeRel.resOrgName}</div></td>
					</tr>	
					</#list>
				</table>
			</div>
				...
				<table id="bottomRightContent" style="width: 403px;" cellpadding="0" cellspacing="0" >
					...
					<tr>
						<#list yearMonths as yearMonth>
							<#assign key = (node.costProjectNodeRel.costProjectNodeRelId + "_" + yearMonth)>
