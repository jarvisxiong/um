						...
						<tr>
							<s:iterator var="plan" value="plans" status="planStatus">
								...
								>
									...
									<s:elseif test="#planDetailStatus == 0"><img src="${ctx}/images/plan/pic_noConfirm.gif" title="新建" /></s:elseif>
									<s:elseif test="#planDetailStatus == 1"><img src="${ctx}/images/plan/pic_confirm.gif" title="进行中" /></s:elseif>
									<s:elseif test="#planDetailStatus == 2"><img src="${ctx}/images/plan/pic_preFinish.gif" title="预完成" /></s:elseif>
									<s:elseif test="#planDetailStatus == 3"><img src="${ctx}/images/plan/pic_finish.gif" title="已完成" /></s:elseif>
								</td>
							</s:iterator>
						</tr>
						</s:iterator>
