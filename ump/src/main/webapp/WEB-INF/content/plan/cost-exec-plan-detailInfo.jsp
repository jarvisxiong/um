...
<div class="plan_detail_div">
	<s:form id="planDetailForm" action="/plan/cost-exec-plan!savePlanDetail.action" method="post">
		<input type="hidden" name="planDetailId" id="planDetailIdHid" value="${planDetailEntity.costExecPlanDetailId}" />
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td align="left">
					<s:if test="(infoInputor && (planDetailEntity.costExecPlanDetailId == null || planDetailEntity.infoConfirmedFlg == 0))
					|| (superAdmin && (planDetailEntity.costExecPlanDetailId != null && planDetailEntity.infoConfirmedFlg == 1))">
			...
			<tr>
				...
				<td style="padding-left: 15px;" id="infoConfirmTd">
					<s:if test="planDetailEntity.costExecPlanDetailId != null">
						<s:if test="superAdmin && planDetailEntity.infoConfirmedFlg != 1">
							<div class="func_icon" onclick="if (confirm('确认过的计划信息将不能再被信息录入员编辑，请问继续吗？')) {confirmInfo('${planDetailEntity.costExecPlanDetailId}');}">确认</div>
						</s:if>
			...
			<tr>
				<td>操作：</td>
				<td>
					<s:if test="planDetailEntity.costExecPlanDetailId != null && planDetailEntity.infoConfirmedFlg == 1">
						<s:if test="projAdmin && planDetailEntity.status == 0">
	...
	<table cellpadding="0" cellspacing="0" style="width: 99%;">
		<tr>
			<td <s:if test="superAdmin || projAdmin">rowspan="2"</s:if> width="100">输出成果：</td>
			<td>
						...
						<table cellpadding="0" cellspacing="0" class="planDetailOutput" border="0">
							<s:iterator value="planDetailOutput">
								<tr>
									...
									<s:if test="superAdmin">
										<td style="padding:0;margin:0;text-align: center;width:20px">
