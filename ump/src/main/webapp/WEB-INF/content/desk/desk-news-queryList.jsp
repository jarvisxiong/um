...
<link  href="${ctx}/resources/css/oa/oa-public-affair.css"rel="stylesheet" type="text/css" />
				...
				<div style="clear:both;margin:0px 2px;overflow: auto; overflow-x: hidden;width:100%;">
					<table class="content_table">
						<tr style="cursor: default;">
							...
							<th width="80px" align="left">点击次数</th>
							<th width="80px" align="left">新闻评论</th>
						</tr>
						...
						<tr class="mainTr" onclick="removeNewImg(this); window.open('${ctx}/oa/oa-news!detail.action?id=${oaNewsId}'); return false;">
							...
							<td align="left"><div><s:date name="newsTime" format="yyyy-MM-dd"/></div></td>
				...
				<div style="margin-top:5px;">
					<div class="read_all">
						...
						<a href="#" onclick="return readAll('${ctx}/desk/desk-news!readAll.action', 'mainForm');">全部置为已读
						</a>
					</div>
