...
<div id="billContent">
			...
			<div class="div_row">
				<span class="wap_title">清单类型:</span> 
				<div><s:checkbox name="templateBean.gbqdFlg" cssClass="group"></s:checkbox><span>国标清单</span></div>
				<div><s:checkbox name="templateBean.gsqdFlg" cssClass="group"></s:checkbox><span>港式清单</span></div>
				<div><s:checkbox name="templateBean.qitaFlg" cssClass="group"></s:checkbox><span>其他</span></div>
			</div>
			</s:if>
