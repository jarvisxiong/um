...
<div id="billContent">
	...
	<div class="div_row">
		...
		<div><s:checkbox name="templateBean.positionLevel3" cssClass="group"></s:checkbox><span>高级经理级(除垂直管理人员外)</span></div>
		<div><s:checkbox name="templateBean.positionLevel4" cssClass="group"></s:checkbox><span>垂直管理人员</span></div>
