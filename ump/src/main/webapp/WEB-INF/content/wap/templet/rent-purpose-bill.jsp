...
<div id="billContent">
		...
		<s:if test="authTypeCd == 'BLSY_ZSGL_ZLHTYX_10'">
		<div class="div_row">
		...
		<div class="div_row">
			...
			<div><s:checkbox name="templateBean.rentTypeCd2" cssClass="group"></s:checkbox><span>意向书</span></div>
			<div><s:checkbox name="templateBean.rentTypeCd1" cssClass="group"></s:checkbox><span>合同</span></div>
		</div>
		<div class="div_row">
		...
		<div class="div_row">
			...
			<div><s:checkbox name="templateBean.standardCd1" cssClass="group"></s:checkbox><span>标准</span></div>
			<div><s:checkbox name="templateBean.standardCd2" cssClass="group"></s:checkbox><span>非标准</span></div>
		</div>
		<div class="div_row">
		...
		<div class="div_row">
			...
			<span>其他</span>
			<span class="wap_vlaue">${templateBean.opertypeCd4Desc}</span>
			</div>
		</div>
		<div class="div_row">
