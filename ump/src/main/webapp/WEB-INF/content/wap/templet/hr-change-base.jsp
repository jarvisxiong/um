...
<div class="billContent">
		...
		<div class="div_label">
			...
			<div class="div_row">
				...
				<div><s:checkbox name="templateBean.adjustItem12" cssClass="group"></s:checkbox><span>离职</span></div>
				<div><s:checkbox name="templateBean.adjustItem11" cssClass="group"></s:checkbox><span>新聘</span></div>
				<div><s:checkbox name="templateBean.adjustItem9"  cssClass="group"></s:checkbox><span>奖励</span></div>
				<div><s:checkbox name="templateBean.adjustItem10"  cssClass="group"></s:checkbox><span>惩罚</span></div>
				<div ><s:checkbox name="templateBean.adjustItem7"  cssClass="group"></s:checkbox><span>其他</span>
				<div ><span class="wap_value">${templateBean.adjustOther}</span></div>
			</div>
		</div>
		<div class="div_label">
			<span class="wap_label">【调整内容】<red>(可左右拖动查看)</red></span>
			<div class="div_scroll">
				<table>
					<tr>
						<td class="wap_title">调整内容</td>
						<td class="wap_title">调整前</td>
						<td class="wap_title">调整后</td>
					</tr>
					<tr>
					<td class="wap_title">中心/公司</td>
					<td><span  class="wap_value">${templateBean.centerBefore}</span></td>
					<td><span  class="wap_value">${templateBean.centerAfter}</span></td>
					</tr>
					<tr>
					<td class="wap_title">部门</td>
					<td><span  class="wap_value">${templateBean.deptBefore}</span></td>
					<td><span  class="wap_value">${templateBean.deptAfter}</span></td>
					</tr>
					<tr>
					<td class="wap_title">职位</td>
					<td><span  class="wap_value">${templateBean.positionBefore}</span></td>
					<td><span  class="wap_value">${templateBean.positionAfter}</span></td>
					</tr>
					<tr>
					<td class="wap_title">职级</td>
					<td><span  class="wap_value">${templateBean.levelBefore}</span></td>
					<td><span  class="wap_value">${templateBean.levelAfter}</span></td>
					</tr>
					<tr>
					<td class="wap_title">工资</td>
					<td><span  class="wap_value">${templateBean.salaryBefore}</span></td>
					<td><span  class="wap_value">${templateBean.salaryAfter}</span></td>
					</tr>
					<tr>
					<td class="wap_title">外派补贴(元)</td>
					...
					<tr>
					<td class="wap_title">交通补贴(元)</td>
					<td><span  class="wap_value">${templateBean.trafficSubsidyBefore}</span></td>
					<td><span  class="wap_value">${templateBean.trafficSubsidyAfter}</span></td>
					</tr>
					<tr>
					<td class="wap_title">通讯补贴(元)</td>
