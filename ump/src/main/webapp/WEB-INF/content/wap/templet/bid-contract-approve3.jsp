...
<div id="billContent">
		...
		<div class="div_row">
 		...
 		<s:if test="templateBean.engineeringName != ''">
		<div class="div_row">
		...
		<s:if test="templateBean.unitName != ''">
		<div class="div_row">
		...
		<div class="div_label">
			...
			<div class="div_row">
				...
				<div><s:checkbox name="templateBean.inviteBidModel1" cssClass="group"></s:checkbox><span>邀请招标单</span></div>
				<div><s:checkbox name="templateBean.inviteBidModel2" cssClass="group"></s:checkbox><span>竞争性谈判</span></div>
				<div><s:checkbox name="templateBean.inviteBidModel3" cssClass="group"></s:checkbox><span>直接委托(战略合作单位)</span></div>
			</div>
			<div class="div_row">
				...
				<div><s:checkbox name="templateBean.pricingModel2" cssClass="group"></s:checkbox><span>单价包干（按当地政府测绘部门最终确认的各业态建筑面积，按实结算）</span></div>
			</div>
			<s:if test="templateBean.budgetAmount != ''">
			<div class="div_row">
				<span class="wap_title">预算金额(元):</span>
				<span class="wap_value">${templateBean.budgetAmount}</span>
			</div>
			</s:if>
			<s:if test="templateBean.paymentType != ''">
			<div class="div_row">
		...
		<div class="div_label">
			...
			<input type="hidden" name="templateBean.bidApprIdFromCont" id="bidApprIdFromCont" value="${templateBean.bidApprIdFromCont}"/>
				<s:if test="templateBean.bidApprIdFromCont !=null ">
					<div class="div_row">
					查看明细：&nbsp;&nbsp;<span id='bidApprSpan' class='link'>定标审批表 </span>
					</div>
				</s:if>
				<s:else>
					<div class="div_row">
			...
			<div class="div_row">
				<span class="wap_title">定标审批单</span>
			...
			<div class="div_row">
				<span class="wap_title">设计任务书</span>
