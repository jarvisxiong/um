/*
 * KindEditor 4.0.5 (2012-01-15), Copyright (C) kindsoft.net, Licence:
 ...
 */(function(
	...
	function Mb(a, b, c) {
		a.addEventListener ? a.addEventListener(b, c, bb) : a.attachEvent
				&& a.attachEvent("on" + b, c)
	}
	function oa(a, b, c) {
		a.removeEventListener ? a.removeEventListener(b, c, bb) : a.detachEvent
	...
	function fa(a, b, c) {
		if (b && b.indexOf(",") >= 0)
			...
			if (d)
				if (b === n)
					d in v && (l(v[d], function(b, c) {
								b != "el" && c.length > 0 && oa(a, b, c[0])
							}), delete v[d], db(a));
				else if (v[d]) {
					var e = v[d][b];
					if (e && e.length > 0) {
						c === n ? (oa(a, b, e[0]), delete v[d][b]) : (l(e,
								function(a, b) {
									a > 0 && b === c && e.splice(a, 1)
								}), e.length == 1
								&& (oa(a, b, e[0]), delete v[d][b]));
						var f = 0;
						l(v[d], function() {
									f++
								});
	...
	function pa(a, b, c, d) {
		...
		b = k(b, "").toLowerCase();
		if (M(b, ["absolute", "relative", "domain"]) < 0)
			return a;
		c = c || location.protocol + "//" + location.host;
		if (d === n)
			var g = location.pathname.match(/^(\/.*)\//), d = g ? g[1] : "";
		var h;
		if (h = /^(\w+:\/\/[^\/]*)/.exec(a)) {
			if (h[1] !== c)
				return a
		...
		/^\//.test(a) ? a = c + e(a.substr(1)) : /^\w+:\/\//.test(a)
				|| (a = c + e(d + "/" + a));
		b === "relative" ? a = f(c + d, 0).substr(2) : b === "absolute"
				&& a.substr(0, c.length) === c && (a = a.substr(c.length));
		return a
	}
	function R(a, b, c, d, e) {
		var c = c || "", d = k(d, !1), e = k(e, "\t"), f = "xx-small,x-small,small,medium,large,x-large,xx-large"
				.split(","), a = a.replace(
		...
		var h = [], a = a
				.replace(
						...
						function(a, m, o, A, K, r, q) {
							var m = m || "", o = o || "", w = A.toLowerCase(), n = K
									|| "", A = r ? " " + r : "", q = q || "";
							if (b && !g[w])
								return "";
							A === "" && gb[w] && (A = " /");
							...
							if (ib[w] && !Fa[w])
								if (d) {
									o && h.length > 0 && h[h.length - 1] === w
											? h.pop()
											: h.push(w);
									q = m = "\n";
									K = 0;
									for (r = o ? h.length : h.length - 1; K < r; K++)
										m += e, o || (q += e);
									A ? h.pop() : o || (q += e)
								} else
									m = q = "";
							if (n !== "") {
								...
								if (w === "font") {
									...
									l(k, function(a, b) {
										if (a === "color")
											p.color = b, delete k[a];
										a === "size"
												&& (p["font-size"] = f[parseInt(
														b, 10)
														- 1]
														|| "", delete k[a]);
										a === "face"
												&& (p["font-family"] = b, delete k[a]);
										a === "style" && (G = b)
									});
									G && !/;$/.test(G) && (G += ";");
									l(p, function(a, b) {
	...
	function ta(a, b) {
		...
		function f(a, b, c) {
			...
			if (c.getElementsByClassName) {
				...
				j = 0;
				for (i = e.length; j < i; j++)
					h = e[j], ra(c, h) && g.push(h)
			} else {
				e = c.getElementsByTagName(b);
				a = " " + a + " ";
				j = 0;
				for (i = e.length; j < i; j++)
					if (h = e[j], h.nodeType == 1)
						(b = h.className) && (" " + b + " ").indexOf(a) > -1
								&& g.push(h)
			}
			return g
		}
		function g(a, b, d, e) {
			for (var f = [], d = e.getElementsByTagName(d), g = 0, j = d.length; g < j; g++)
				e = d[g], e.nodeType == 1
						&& (b === null
								? sa(e, a) !== null && f.push(e)
								: b === c(sa(e, a)) && f.push(e));
			return f
		}
		function h(a, b) {
			var c = [], j, h = (j = /^((?:\\.|[^.#\s\[<>])+)/.exec(a))
					? j[1]
					: "*";
			if (j = /#((?:[\w\-]|\\.)+)$/.exec(a))
				c = e(j[1], h, b);
				...
				if (c === "id")
					...
					j = (b.ownerDocument || b).getElementsByName(j.replace(
							/\\/g, ""));
					for (var m, o = 0, q = j.length; o < q; o++)
						m = j[o], d(h, m.nodeName) && ra(b, m)
								&& m.getAttributeNode("name") && c.push(m);
					h = c
				} else
					h = g(c, j, h, b);
				c = h
				...
				m = 0;
				for (o = h.length; m < o; m++)
					j = h[m], j.nodeType == 1 && c.push(j)
			}
			return c
		}
		var j = a.split(",");
		...
		for (var b = b || document, j = [], o, A = /((?:\\.|[^\s>])+|[\s>])/g; o = A
				.exec(a);)
			o[1] !== " " && j.push(o[1]);
		o = [];
		if (j.length == 1)
			...
			if (K = j[p], K === ">")
				...
				if (p > 0) {
					...
					for (s = o.length; qa < s; qa++) {
						...
						q = h(K, k);
						G = 0;
						for (t = q.length; G < t; G++)
							n = q[G], A ? k === n.parentNode && r.push(n) : r
									.push(n)
					}
					o = r
				} else
	...
	function Y(a) {
		var a = a || document, b;
		p || Ja
				? (b = H(a).scrollLeft, a = H(a).scrollTop)
				: (b = S(a).scrollX, a = S(a).scrollY);
		return {
			x : b,
			y : a
		}
	...
	function Ka(a, b, c) {
		function d(d, e, f) {
			...
			b
					&& (j = d.cloneNode(!0), j = e > 0 ? j.splitText(e) : j, f < g
							&& j.splitText(f - e));
			if (c) {
				var i = d;
		...
		function f(e, q) {
			for (var k = e.firstChild, r; k;) {
				...
				m >= 0 && o <= 0 && (o = r.compareBoundaryPoints(ia, a));
				...
				if (m > 0)
					if (k.nodeType == 1)
						if (o >= 0 && A <= 0)
							b && q.appendChild(k.cloneNode(!0)), c && h.push(k);
						else {
							var n;
							//进入表格后直接装入表格
							//b && (n = k.cloneNode(!1), q.appendChild(n));
							b && (n = k.cloneNode(!0), q.appendChild(n));
							//将选择表格删除
							//h.push(k);
							//现只要选择到表格上就clone整个表格，所以不再往里面进行递归
							//if (f(k, n) === !1)
							//	return !1
						}
					else if (k.nodeType == 3
							&& (k = k == j.startContainer ? d(k, j.startOffset,
									k.nodeValue.length) : k == j.endContainer
									? d(k, 0, j.endOffset)
									: d(k, 0, k.nodeValue.length), b))
						try {
							q.appendChild(k)
						} catch (p) {
						}
		...
		var g = a.doc, h = [], j = a.cloneRange().down(), m = -1, o = -1, A = -1, l = -1, r = a
				.commonAncestor(), q = g.createDocumentFragment();
		if (r.nodeType == 3)
			return r = d(r, a.startOffset, a.endOffset), b && q.appendChild(r), e(), b
					? q
					: a;
		f(r, q);
		c && a.up().collapse(!0);
	...
	function ob(a, b) {
		...
		for (var o = 0, k = i.length; o < k; o++) {
			...
			if (l.nodeType == 1) {
				...
				n.isControl()
						&& (q = c.createElement("span"), n.after(q), p = q, h += n
								.text().replace(/\r\n|\n|\r/g, "").length);
				ka(r, p);
				...
				l.nodeType == 3
						&& (m.moveStart("character", l.nodeValue.length), h += l.nodeValue.length);
			j < 0 && (g = l)
		}
		if (j < 0 && g.nodeType == 1)
			return {
		...
		if (j > 0)
			for (; g.nextSibling && g.nodeType == 1;)
				g = g.nextSibling;
		m = a.duplicate();
		ka(m, e);
		...
		h -= m.text.replace(/\r\n|\n|\r/g, "").length;
		if (j > 0 && g.nodeType == 3)
			for (c = g.previousSibling; c && c.nodeType == 3;)
				h -= c.nodeValue.length, c = c.previousSibling;
		return {
			node : g,
			offset : h
		}
	...
	function pb(a, b) {
		...
		if (a.nodeType == 1 && a.childNodes.length > 0) {
			...
			if (i.nodeType == 1) {
				var g = f(i), h;
				g.isControl()
						&& (h = c.createElement("span"), e ? g.before(h) : g
								.after(h), i = h);
				ka(d, i);
				d.collapse(e);
				h && f(h).remove();
	...
	function qb(a) {
		...
		if (p) {
			if (a.item)
				return c = X(a.item(0)), c = new N(c), c.selectNode(a.item(0)), c;
	...
	function ub(a, b, c) {
		...
		if (a.type === 1 && (b = sb(b), b[c])) {
			for (var c = b[c].split(","), b = !1, d = 0, e = c.length; d < e; d++) {
				...
				var g = /^(\.?)([^=]+)(?:=([^=]*))?$/.exec(f), f = g[2];
				g[1] ? (f = ea(f), a[0].style[f] && (a[0].style[f] = "")) : a
						.removeAttr(f)
			}
			b && a.remove(!0)
		}
	...
	function vb(a) {
		for (; a && a.name != "body";) {
			if (Fa[a.name] || a.name == "div" && a.hasClass("ke-script"))
				return !0;
			a = a.parent()
		}
		return !1
	...
	function wb(a) {
		a.nodeName
				&& (a = X(a), a = La(a).selectNodeContents(a.body).collapse(!1));
		return new ua(a)
	}
	function Qa(a) {
		...
		d.mousedown(function(a) {
					var m = d.get(), o = t(b.css("left")), k = t(b.css("top")), n = b
							.width(), r = b.height(), q = a.pageX, p = a.pageY, s = !0;
					e && e();
					l(i, function(a, b) {
								function e(b) {
									if (s) {
										var f = P(g[a].x + b.pageX - q), j = P(g[a].y
												+ b.pageY - p);
								...
								f(b).mousemove(e).mouseup(i).bind(
										"selectstart", j);
								h.push({
											doc : b,
											move : e,
	...
	function Ub(a, b, c, d) {
		var e = [
				...
				"}", ".ke-script {", "\tdisplay:none;", "\tfont-size:0;",
				"\twidth:0;", "\theight:0;", "}", ".ke-pagebreak {",
	...
	function Va(a, b) {
		var c = document.getElementsByTagName("head")[0]
				|| (T ? document.body : document.documentElement), d = document
	...
	function Wa(a) {
		for (var b = document.getElementsByTagName("head")[0]
				|| (T ? document.body : document.documentElement), c = document
				.createElement("link"), d = pa(a, "absolute"), e = f(
				'link[rel="stylesheet"]', b), i = 0, g = e.length; i < g; i++)
			if (pa(e[i].href, "absolute") === d)
				return;
		b.appendChild(c);
		c.href = a;
		c.rel = "stylesheet"
			...
			if (a.useContextmenu) {
				if (a._contextmenus.length !== 0) {
					...
					if (d.length > 0) {
						...
						b.clientY + h >= i.clientHeight - 100
								&& g.pos(g.x, t(g.y) - h);
			...
			f(c).keyup(function(e) {
				if (!(e.which != 13 || e.shiftKey || e.ctrlKey || e.altKey)
					...
					if (b.cmd.selection(), e = a(b.cmd.range), !(e == "marquee" || e == "select"))
						if (i[e] || O(c, "formatblock", "<p>"), e = b.cmd
								.commonAncestor("div")) {
	...
	function Hb(a, b) {
		var c = this.edit, d = c.doc.body, e, i;
		if (a.length === 0)
			return this;
		c.designMode
				? (e = this.cmd.range, i = e.createBookmark(!0), i.html = d.innerHTML)
				: i = {
					html : d.innerHTML
				};
		Gb(b, i);
		...
		c.designMode ? (c.html(g.html), g.start
				&& (e.moveToBookmark(g), this.select())) : f(d).html(U(g.html));
		return this
	}
	function Aa(a) {
		function b(a, b) {
	...
	if (!B.KindEditor) {
		...
		var z = navigator.userAgent.toLowerCase(), p = z.indexOf("msie") > -1
				&& z.indexOf("opera") == -1, la = z.indexOf("gecko") > -1
				&& z.indexOf("khtml") == -1, ca = z.indexOf("applewebkit") > -1, Ja = z
				.indexOf("opera") > -1, Zb = z.indexOf("mobile") > -1, $b = /ipad|iphone|ipod/
				.test(z), T = document.compatMode != "CSS1Compat", F = (z = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/
				.exec(z)) ? z[1] : "0", Ba = (new Date).getTime(), P = Math.round, f = {
			DEBUG : !1,
		...
		f.options = {
			...
			items : ["source", "|", "undo", "redo", "|", "preview", "print",
					...
					"insertfile", "table", "hr", "mark", "map", "code",//mark标注
		...
		var bc = "altKey,attrChange,attrName,bubbles,button,cancelable,charCode,clientX,clientY,ctrlKey,currentTarget,data,detail,eventPhase,fromElement,handler,keyCode,metaKey,newValue,offsetX,offsetY,originalTarget,pageX,pageY,prevValue,relatedNode,relatedTarget,screenX,screenY,shiftKey,srcElement,target,toElement,view,wheelDelta,which"
				.split(",");
		E(cb, {
					init : function(a, b) {
		...
		f.ready = function(a) {
			...
			document.addEventListener
					? W(document, "DOMContentLoaded", b)
					: document.attachEvent
							&& (W(document, "readystatechange", d), document.documentElement.doScroll
									&& B.frameElement === n && c());
			W(B, "load", b)
		};
		f.formatUrl = pa;
		...
		E(I, {
			init : function(a) {
				for (var b = 0, c = a.length; b < c; b++)
					this[b] = a[b].constructor === I ? a[b][0] : a[b];
			...
			attr : function(a, b) {
				...
				if (b === n)
					return b = c.length < 1 ? null : sa(c[0], a), b === null
							? ""
							: b;
				c.each(function() {
							Ha(this, a, b)
			...
			addClass : function(a) {
				this.each(function() {
							if (!ma(a, this.className, " "))
								this.className = C(this.className + " " + a)
						});
				return this
			},
			removeClass : function(a) {
				this.each(function() {
							if (ma(a, this.className, " "))
								this.className = C(this.className.replace(
										RegExp("(^|\\s)" + a + "(\\s|$)"), " "))
						});
				return this
			},
			...
			val : function(a) {
				if (a === n) {
					...
					return this.each(function() {
								Jb[Ia(this)] ? this.value = a : Ha(this,
										"value", a)
							}), this
			},
			css : function(a, b) {
			...
			pos : function() {
				...
				if (a)
					if (a.getBoundingClientRect)
						a = a.getBoundingClientRect(), c = Y(this.doc), b = a.left
								+ c.x, c = a.top + c.y;
					else
						for (; a;)
			...
			children : function() {
				...
				for (var a = [], b = this[0].firstChild; b;)
					(b.nodeType != 3 || C(b.nodeValue) !== "")
							&& a.push(new I([b])), b = b.nextSibling;
				return a
			},
			first : function() {
				var a = this.children();
			...
			scan : function(a, b) {
				...
				if (!(this.length < 1))
					return b = b === n ? !0 : b, c(this[0]), this
			}
		});
		l(
		...
		E(N, {
			...
			commonAncestor : function() {
				...
				for (var b = a(this.startContainer), c = a(this.endContainer), d = 0, e = b.length, f = c.length, g, h; ++d;)
					if (g = b[e - d], h = c[f - d], !g || !h || g !== h)
						break;
				return b[e - d + 1]
			},
			...
			selectNodeContents : function(a) {
				...
				b = b.children();
				if (b.length > 0)
					return this.setStartBefore(b[0][0]).setEndAfter(b[b.length
							- 1][0]);
			...
			compareBoundaryPoints : function(a, b) {
				...
				if (p) {
					...
					var i, g, h, j;
					if (a === ia || a === ja)
						i = this.startContainer, h = this.startOffset;
					if (a === ha || a === Z)
						i = this.endContainer, h = this.endOffset;
					if (a === ia || a === ha)
						g = b.startContainer, j = b.startOffset;
					if (a === Z || a === ja)
						g = b.endContainer, j = b.endOffset;
					if (i === g)
						return i = h - j, i > 0 ? 1 : i < 0 ? -1 : 0;
					for (c = g; c && c.parentNode !== i;)
						c = c.parentNode;
					if (c)
						return f(c).index() >= h ? -1 : 1;
					for (c = i; c && c.parentNode !== g;)
						c = c.parentNode;
					if (c)
						return f(c).index() >= j ? 1 : -1;
					if ((c = f(g).next()) && c.contains(i))
						return 1;
					if ((c = f(i).next()) && c.contains(g))
						return -1
				} else
					return c.compareBoundaryPoints(a, d)
			},
			cloneRange : function() {
				return (new N(this.doc)).setStart(this.startContainer,
			...
			insertNode : function(a) {
				...
				if (a.nodeName.toLowerCase() === "#document-fragment")
					f = a.firstChild, g = a.lastChild, j = a.childNodes.length;
				b.nodeType == 1
						? (h = b.childNodes[c])
								? (b.insertBefore(a, h), b === d && (e += j))
								: b.appendChild(a)
						: b.nodeType == 3
								&& (c === 0
										...
										: c >= b.nodeValue.length
												...
												: (h = c > 0
														? b.splitText(c)
														: b, b.parentNode
														.insertBefore(a, h), b === d
														&& (d = h, e -= c)));
				f ? this.setStartBefore(f).setEndAfter(g) : this.selectNode(a);
				if (this.compareBoundaryPoints(Z, this.cloneRange()
								.setEnd(d, e)) >= 1)
					return this;
			...
			get : function(a) {
				...
				b.setEndPoint("StartToStart", pb(a.startContainer,
								a.startOffset));
		...
		E(ua, {
			...
			selection : function(a) {
				...
				this.sel = Ma(b);
				if (c)
					return this.range = La(c), f(this.range.startContainer).name == "html"
			...
			select : function(a) {
				var a = k(a, !0), b = this.sel, c = this.range.cloneRange()
						.shrink(), d = c.startContainer, e = c.startOffset, i = X(d), g = this.win, h, j = !1;
				if (a && d.nodeType == 1 && c.collapsed) {
					...
					if (ca
							&& (a = d.childNodes, f(d).isInline() || e > 0
									...
									&& f(a[e]).isInline()))
						c.insertNode(i.createTextNode("\u200b")), j = !0
				}
				if (p)
					try {
						h = c.get(!0), h.select()
					...
					j && c.collapse(!1), h = c.get(!0), b.removeAllRanges(), b
							.addRange(h);
				g.focus();
				return this
			},
				...
				f(a).scan(function(a) {
					if (!i && a == e.start)
						...
						if (!vb(b) && b.type == 3 && C(a.nodeValue).length > 0) {
							...
							d = d.clone(!0);
							if (b.type == 3)
								Pa(d).append(b.clone(!1)), b.replaceWith(d);
							else {
								for (var a = b, m; (m = b.first())
										&& m.children().length == 1;)
									b = m;
								m = b.first();
								for (b = b.doc.createDocumentFragment(); m;)
									b.appendChild(m[0]), m = m.next();
								m = a.clone(!0);
								for (var o = Pa(m), k = m, l = !1; d;) {
									for (; k;)
										k.name === d.name
												&& (Tb(k, d.attr(), d.css()), l = !0), k = k
												.first();
			...
			split : function(a, b) {
				for (var c = this.range, d = c.doc, e = c.cloneRange()
						.collapse(a), i = e.startContainer, g = e.startOffset, h = i.nodeType == 3
						? i.parentNode
						: i, j = !1, m; h && h.parentNode;) {
					m = f(h);
					if (b) {
						if (!m.isStyle())
							break;
				...
				if (j)
					d = d.createElement("span"), c.cloneRange().collapse(!a)
							...
							.setEnd(i, g) : e.setStart(i, g)
							.setEndAfter(h.lastChild), i = e.extractContents(), g = i.firstChild, j = i.lastChild, a
							? (e.insertNode(i), c.setStartAfter(j)
									.setEndBefore(d))
							: (h.appendChild(i), c.setStartBefore(d)
									.setEndBefore(g)), e = d.parentNode, e == c.endContainer
							&& (h = f(d).prev(), i = f(d).next(), h && i
									&& h.type == 3 && i.type == 3 ? c.setEnd(
			...
			remove : function(a) {
				...
				if (d > 0) {
					...
					o
							&& $(o)
							&& (o.remove(), c.setStart(b, d - 1), b == e
									&& c.setEnd(e, m - 1));
					if ((d = f(b.childNodes[d])) && $(d))
						d.remove(), b == e && c.setEnd(e, m - 1)
				}
			...
			commonAncestor : function(a) {
				...
				var c = this.range, d = c.startContainer, e = c.startOffset, i = c.endContainer, c = c.endOffset, i = i.nodeType == 3
						|| c === 0 ? i : i.childNodes[c - 1], d = b(d.nodeType == 3
						|| e === 0 ? d : d.childNodes[e - 1]), e = b(i);
				if (d && e && d === e)
					return f(d);
				return null
			},
			...
			val : function(a) {
				...
				if (a === "fontfamily" || a === "fontname")
					return c = rb(b, "fontname"), c = c.replace(/['"]/g, ""), c
							.toLowerCase();
				if (a === "formatblock") {
					c = rb(b, a);
				...
				if (a === "forecolor")
					return (a = this.commonNode({
								"*" : ".color"
							})) && (c = a.css("color")), c = na(c), c === ""
							&& (c = "default"), c.toLowerCase();
				if (a === "hilitecolor"){
					return (a = this.commonNode({
						"*" : ".background-color"
					})) && (c = a.css("background-color")), c = na(c), c === ""
					&& (c = "default"), c.toLowerCase();
				}
				return c
			},
			...
			},markcolor:function(a,id){
				alert(a);
			return this.toggle('<span mkid="'+id+'" style="background-color:' + a
								+ ';"></span>', {
							span : ".background-color=" + a
						})
			},
			...
			createlink : function(a, b) {
				...
				b && (e += ' target="' + D(b) + '"');
				if (d.collapsed)
					return e += ">" + D(a) + "</a>", this.inserthtml(e);
				if (d.isControl()) {
		...
		E(Q, {
			...
			autoPos : function(a, b) {
				...
				if (this._alignEl) {
					var i = f(this._alignEl), g = i.pos(), c = P(i[0].clientWidth
							/ 2 - c / 2), d = P(i[0].clientHeight / 2 - d / 2);
					x = c < 0 ? g.x : g.x + c;
					y = d < 0 ? g.y : g.y + d
				} else
					g = H(this.doc), x = P(e.x + (g.clientWidth - c) / 2), y = P(e.y
							+ (g.clientHeight - d) / 2);
				p && F < 7 || T || (x -= e.x, y -= e.y);
				return this.pos(x, y)
			},
			...
			init : function(a) {
				function b() {
					...
					ca && f(b).click(function(a) {
						f(a.target).name === "img"
								&& (j.selection(!0), j.range
										.selectNode(a.target), j.select())
					});
				...
				var d = k(a.themesPath, ""), e = a.bodyClass, i = a.cssPath, g = a.cssData, h = location.host
						.replace(/:\d+/, "") !== document.domain, j = "document.open();"
						+ (h
						...
						: "";
				c.iframe = f('<iframe class="ke-edit-iframe" id="keEditIframe" hidefocus="true" frameborder="0"'
		...
		E(Ta, Q, {
					...
					disableAll : function(a, b) {
						...
						b && (d = u(b));
						(a === n ? !c.disableMode : a) ? (f("span.ke-outline",
								c.div).each(function() {
		...
		E(wa, Q, {
			...
			addItem : function(a) {
				if (a.title === "-")
					...
					var b = f('<div class="ke-menu-item" unselectable="on"></div>'), c = f('<div class="ke-inline-block ke-menu-item-left"></div>'), d = f('<div class="ke-inline-block ke-menu-item-right"></div>'), e = s(a.height), i = k(
							a.iconClass, "");
					this.div.append(b);
					e && (b.css("height", e), d.css("line-height", e));
					var g;
					this.centerLineMode
							&& (g = f('<div class="ke-inline-block ke-menu-item-center"></div>'), e
									&& g.css("height", e));
		...
		E(xa, Q, {
			init : function(a) {
				...
				for (var e = 0; e < b.length; e++)
					for (var c = a.insertRow(e + 1), f = 0; f < b[e].length; f++)
						d = c.insertCell(f), this._addAttr(d, b[e][f],
								"ke-colorpicker-cell")
			},
		...
		E(Bb, {
			init : function(a) {
				var b = f(a.button), c = a.fieldName || "file", d = a.url || "", e = b
						.val(), i = b[0].className || "", g = "kindeditor_upload_iframe_"
						+ (new Date).getTime();
				a.afterError = a.afterError || function(a) {
					alert(a)
				};
				c = [
						'<div class="ke-inline-block ' + i + '">',
						'<iframe name="' + g
				...
				this.fileBox = f(".ke-upload-file", c)
						.width(f(".ke-button-common").width());
				this.options = a
			},
			submit : function() {
				...
				b.bind("load", function() {
					b.unbind();
					var c = f.iframeDoc(b), e = c.getElementsByTagName("pre")[0], i = "", g, i = e
							? e.innerHTML
							: c.body.innerHTML;
					try {
						g = f.json(i)
		...
		E(ya, Q, {
			init : function(a) {
				...
				var c = a.title, d = f(a.body, this.doc), e = a.previewBtn, i = a.yesBtn, g = a.noBtn, h = a.closeBtn, j = k(
						a.showMask, !0);
				this.div.addClass("ke-dialog").bind("click,mousedown",
						function(a) {
							a.stopPropagation()
						});
				var m = f('<div class="ke-dialog-content"></div>')
						.appendTo(this.div);
				p && F < 7
				...
				this.height
						&& a.height(t(this.height) - b.height() - o.height());
				this.div.width(this.div.width());
				this.div.height(this.div.height());
				this.mask = null;
				if (j)
					d = H(this.doc), this.mask = Sa({
								x : 0,
								y : 0,
								z : this.z - 1,
								cls : "ke-dialog-mask",
		...
		f.ajax = function(a, b, c, d, e) {
			var c = c || "GET", e = e || "json", f = B.XMLHttpRequest
		...
		Aa.prototype = {
			...
			loadPlugin : function(a, b) {
				...
				Va(		c.pluginsPath
								...
								+ a
								+ ".js?ver="
								+ encodeURIComponent(f.DEBUG
										? Ba
										: "4.0.5 (2012-01-15)"), function() {
							c.isLoading = !1;
			...
			create : function() {
				...
				function b(a, b, d) {
					d = k(d, !0);
					if (a && a >= c.minWidth && (c.resize(a, null), d))
						c.width = s(a);
					if (b && b >= c.minHeight && (c.resize(null, b), d))
						c.height = s(b)
				}
				...
				var e = d ? H().clientWidth + "px" : c.width, i = d
						? H().clientHeight + "px"
						: c.height;
				if (p && F < 8 || T)
					i = s(t(i) + 2);
				...
				var h = f(".toolbar", g), j = f(".edit", g), m = c.statusbar = f(
						".statusbar", g);
				...
				if (d) {
					...
					c._scrollPos
							&& (f(document.body).css({
									...
									"overflow", ""), B.scrollTo(c._scrollPos.x,
									c._scrollPos.y));
				var o = [];
				...
				var h = c.toolbar = zb({
					...
					beforeGetHtml : function(a) {
						a = c.beforeGetHtml(a);
						return R(a, c.filterMode ? c.htmlTags : null,
				...
				a();
				d
						? (f(B).bind("resize", function() {
							c.isCreated
									&& b(H().clientWidth, H().clientHeight, !1)
						}), h.select("fullscreen"), m.first().css("visibility",
								"hidden"), m.last().css("visibility", "hidden"))
						: (la && f(B).bind("scroll", function() {
									c._scrollPos = Y()
								}), c.resizeType > 0 ? Qa({
									moveEl : g,
									clickEl : m,
			...
			resize : function(a, b) {
				a !== null && t(a) > this.minWidth
						&& this.container.css("width", s(a));
				b !== null
						&& (b = t(b) - this.toolbar.div.height()
								- this.statusbar.height(), b > 0
								&& t(b) > this.minHeight
								&& this.edit.setHeight(b));
				return this
			},
			select : function() {
			...
			html : function(a) {
				if (a === n)
					return this.isCreated
							? this.edit.html()
							: aa(this.srcElement);
				this.isCreated ? this.edit.html(a) : aa(this.srcElement, a);
				return this
			},
			fullHtml : function() {
			...
			text : function(a) {
				return a === n ? C(this.html().replace(/<(?!img|embed).*?>/ig,
			...
			selectedText : function() {
				...
				return val.replace(/<(?!img|embed).*?>/ig, '').replace(
						/&nbsp;/ig, ' ');
			},
			...
			exec : function(a) {
				var a = a.toLowerCase(), b = this.cmd, c = M(a,
			...
			addBookmark : function(a) {
				...
				if (a
						...
						&& Math
								.abs(d.length
										- U(this._undoStack[this._undoStack.length
												- 1].html).length) < this.minChangeSize)
					return this;
				b.designMode && !this._firstAddBookmark
						? (b = this.cmd.range, a = b.createBookmark(!0), a.html = Xa(c.innerHTML), b
								.moveToBookmark(a))
						: a = {
							html : d
						};
			...
			readonly : function(a) {
				...
				b.designMode ? b.toolbar.disableAll(a, []) : l(
						b.noDisableItems, function() {
							b.toolbar[a ? "disable" : "enable"](this)
						});
				p ? d.body.contentEditable = !a : d.designMode = a
						? "off"
						: "on";
			...
			createMenu : function(a) {
				...
				a.selectedColor !== n
						? (a.cls = "ke-colorpicker-" + this.themeType, a.noColor = this
								.lang("noColor"), this.menu = Ab(a))
						: (a.cls = "ke-menu-" + this.themeType, a.centerLineMode = !1, this.menu = Ua(a));
				return this.menu
			},
			hideMenu : function() {
				this.menu.remove();
		...
		f.create = function(a, b) {
			...
			if (d = f(a)) {
				b.srcElement = d[0];
				if (!b.width)
					b.width = d[0].style.width || d.width();
				if (!b.height)
					b.height = d[0].style.height || d.height();
				var e = new Aa(b);
				if (L[e.langType])
					return c(e);
				Va(		e.langPath
		...
		Db("core", function(a) {
			...
			b.clickToolbar("formatblock", function() {
						var a = b.lang("formatblock.formatBlock"), c = {
							...
							H4 : 14,
							p : 12
						}, d = b.cmd.val("formatblock"), e = b.createMenu({
									name : "formatblock",
		...
		b.plugin.setMarkColor=function(color,id){					
		b.cmd.markcolor(color,id);					
		}
			...
			b.afterCreate(function() {
				function c() {
					...
					e.select();
					ca
							&& (a("div." + i, g).each(function() {
										a(this).after("<br />").remove(!0)
									}), a("span.Apple-style-span", g)
									.remove(!0), a("meta", g).remove());
					var d = g[0].innerHTML;
					g.remove();
					d !== ""
							&& (b.pasteType === 2
				...
				a(d.body).bind("paste", function(l) {
							if (b.pasteType === 0)
								...
								if (p) {
									...
									e.range.selectNodeContents(g[0]), e
											.select();
								setTimeout(function() {
											c();
											k = !1
				...
				return a
						.replace(
								...
								function(a) {
									...
									c.height = k(a.height, t(k(b.height, "")));
									return Ga(c)
								})
