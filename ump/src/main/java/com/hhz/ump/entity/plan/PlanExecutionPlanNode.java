 ...
 */
@Entity
@Table(name="PLAN_EXECUTION_PLAN_NODE"
    
)
public class PlanExecutionPlanNode  implements java.io.Serializable {
    ...
    public PlanExecutionPlanNode() {
    }

	
    public PlanExecutionPlanNode(String planExecutionPlanNodeId, long recordVersion) {
        this.planExecutionPlanNodeId = planExecutionPlanNodeId;
        this.recordVersion = recordVersion;
    }
    public PlanExecutionPlanNode(String planExecutionPlanNodeId, String resOrgCd, String resOrgName, String corOrgName, String outputFiles, String corOrgCd, String controlNodeFlg, String nodeCd, String nodeName, String activeFlg, String resCenterOrgCd,String planTypeCd, String remark, String creator, String createdDeptCd, Date createdDate, String updator, String updatedDeptCd, Date updatedDate, long recordVersion, String treeType, String treeParentNodeId,String treeParentNodeName, long order1, long order2, long order3,String relDisplayNodeId,String relDisplayNodeName,Long sequenceNo,Long pointLevel, String periodName) {
       this.planExecutionPlanNodeId = planExecutionPlanNodeId;
