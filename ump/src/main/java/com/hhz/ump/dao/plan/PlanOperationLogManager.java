...
import com.hhz.ump.entity.plan.PlanOperationLog;
import com.hhz.ump.util.DictContants;

@Service
@Transactional
public class PlanOperationLogManager extends BaseService<PlanOperationLog, String> {
	@Autowired
	private PlanOperationLogDao planOperationLogDao;
	...
	public void savePlanOperationLog(PlanOperationLog planOperationLog) {
	...
	public HibernateDao<PlanOperationLog, String> getDao() {
	 ...
	 * @param operationLog 操作记录
	 public void addNewlog(String modifiedObj, String operationType, String projCd, String operationLog) {
		 PlanOperationLog opLog = new PlanOperationLog();
	...
	public void addPlanLog(String planTypeCd, String bizEntityId, String modifiedObj, String operationType, String projCd,
		...
		if(DictContants.PLAN_TYPE_PRE.equals(planTypeCd)){
			this.addLog(PlanOperationLogManager.MODULE_PRE_PLAN, bizEntityId, modifiedObj, operationType, projCd, null,
					operationLog);
		}
		else if(DictContants.PLAN_TYPE_EXC.equals(planTypeCd)){
			this.addLog(PlanOperationLogManager.MODULE_EXEC_PLAN, bizEntityId, modifiedObj, operationType, projCd, null,
					operationLog);
		}
		else if(DictContants.PLAN_TYPE_COST.equals(planTypeCd)){
			this.addLog(PlanOperationLogManager.MODULE_COST_PLAN, bizEntityId, modifiedObj, operationType, projCd, null,
					operationLog);
		} 
		else
	...
	public void addTemplateLog(String planTypeCd, String bizEntityId, String modifiedObj, String operationType, String projCd,
		...
		if(DictContants.PLAN_TYPE_EXC.equals(planTypeCd)){
			this.addLog(PlanOperationLogManager.MODULE_EXEC_PLAN_TEMP, bizEntityId, modifiedObj, operationType, projCd, null,
					operationLog);
		}
		else if(DictContants.PLAN_TYPE_PRE.equals(planTypeCd)){
			this.addLog(PlanOperationLogManager.MODULE_PRE_PLAN_TEMP, bizEntityId, modifiedObj, operationType, projCd, null,
					operationLog);
		}
		else if(DictContants.PLAN_TYPE_COST.equals(planTypeCd)){
			this.addLog(PlanOperationLogManager.MODULE_COST_PLAN_TEMP, bizEntityId, modifiedObj, operationType, projCd, null,
					operationLog);
		}
		else
	...
	public void addCEOTaskLog(String bizEntityId, String modifiedSn, String operationType, String operationLog) {
		this.addLog(PlanOperationLogManager.MODULE_CEO_TASK, bizEntityId, modifiedSn, operationType, null, null,
				operationLog);
	}
	...
	public void addSpecialTaskLog(String bizEntityId, String modifiedSn, String operationType, String operationLog) {
		this.addLog(PlanOperationLogManager.MODULE_SPECIAL_TASK, bizEntityId, modifiedSn, operationType, null, null,
				operationLog);
	}
	...
	public void addWorkPlanLog(String bizEntityId, String modifiedSn, String operationType, String deptCd,
			String operationLog) {
		this.addLog(PlanOperationLogManager.MODULE_WORK_PLAN, bizEntityId, modifiedSn, operationType, null, deptCd,
				operationLog);
	}

	public void addPlanWorkCenterLog(String bizEntityId, String modifiedSn, String operationType, String deptCd,
			String operationLog) {
		this.addLog(PlanOperationLogManager.MODULE_PLAN_WORK_CENTER, bizEntityId, modifiedSn, operationType, null,
				deptCd, operationLog);
	}
