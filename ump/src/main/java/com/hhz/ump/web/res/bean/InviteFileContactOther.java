 ...
 * 合同审批表（其他情况）
 * 
 * @author huangj 2010-12-2
 */
public class InviteFileContactOther extends BaseContractTemplate {
	...
	private List<InviteOtherProperty> otherProperties = new ArrayList<InviteOtherProperty>();
	...
	public List<InviteOtherProperty> getOtherProperties() {
		return otherProperties;
	}

	public void setOtherProperties(List<InviteOtherProperty> otherProperties) {
