 ...
 * 2011-04-21
 */
public class MaterialSettlementPayment extends BaseContLedgerTemplate {
	 ...
	 * 材料设备结算审批表
	 */
	private String materialSettlementApproveId;
	...
	public String getMaterialSettlementApproveId() {
		return materialSettlementApproveId;
	}

	public void setMaterialSettlementApproveId(String materialSettlementApproveId) {
		this.materialSettlementApproveId = materialSettlementApproveId;
	}
	...
	public void doImport() {
		...
		//contSettlement.setContLedgerId(getContLedgerId());
