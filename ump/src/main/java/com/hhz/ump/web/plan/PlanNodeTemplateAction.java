...
public class PlanNodeTemplateAction extends CrudActionSupport<PlanExecutionPlanNode> {
	...
	private PlanExecutionPlanNode entity;


	//模板节点列表(按类型)
	private List<PlanExecutionPlanNode> templateNodeList;
...
//		Collections.sort(templateNodeList, new Comparator<PlanExecutionPlanNode>() {
...
//		});
	...
	protected void prepareModel() throws Exception {
		if (StringUtils.isBlank(this.getId())) {
			entity = new PlanExecutionPlanNode(); 
	...
	public PlanExecutionPlanNode getModel() {
		return entity;
	} 
	...
	public List<PlanExecutionPlanNode> getTemplateNodeList() {
		return templateNodeList;
	}

	public void setTemplateNodeList(List<PlanExecutionPlanNode> templateNodeList) {
