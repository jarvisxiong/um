 ...
 * 生成打印随机序号
 * 
 * @author qlb 3/1/2012 version 1.0.0
 * 
 */
public class RandomSeriNoUtils {
	...
	public static String getZD(String strName) {
		 if (strName.equals("标准"))
			return "SC";
		else if (strName.equals("非标"))
			return "NSC";
		else
			return "error";
	}
	...
	public static String getBicker(String str, String str1) {
		String str2 = RandomSeriNoUtils.getZD(str);
		String str3 = RandomSeriNoUtils.getFuction(str1);
		String date = RandomSeriNoUtils.getDateString();
		String num = RandomSeriNoUtils.generateString();
