...
public class JXLExcelUtil {
	 ...
	 * @throws Exception
	 */
	public static InputStream initJxlsInputStream(Map beans, String templateName) throws Exception {

		XLSTransformer transformer = new XLSTransformer();
		InputStream isTemplate = ResApproveInfoAction.class.getClassLoader().getResourceAsStream("jxlsTemplates/" + templateName);
