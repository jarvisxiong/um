 ...
 */
@Namespace("/planold")
@Results( { @Result(name = "matrix", location = "/WEB-INF/content/planold/plan-exec-plan-stat-matrix.ftl", type = "freemarker") })
public class PlanExecPlanStatAction extends ActionSupport {
    
	private static final long serialVersionUID = -1896922716898110663L;
	...
	private List<PlanExecutionPlanOld> operations = new ArrayList<PlanExecutionPlanOld>();// 项目的业态清单

	private PlanExecutionPlanMainOld project;
	...
	private List<PlanExecPlanDetailOld> detailNodes = new ArrayList<PlanExecPlanDetailOld>();
	private List<PlanProjectNodeRelOld> ctrlNodes = new ArrayList<PlanProjectNodeRelOld>();
...
//					}
		...
		// 项目公司
			...
			List<PlanExecutionPlanMainOld> list = planExecutionPlanMainManager.getProjectListByProjectCd(projectCd);
			PlanExecutionPlanMainOld obj = null;
			for (int i = 0; i < list.size(); i++) {
				obj = list.get(i);
...
//		infoInputor = permissions[2];
	...
	public String switchOperation() {
		...
		PlanExecutionPlanOld operationPlan = planExecutionPlanManager.getEntity(operationId);
	...
	public PlanExecutionPlanMainOld getProject() {
		return project;
	}

	public void setProject(PlanExecutionPlanMainOld project) {
		this.project = project;
	}

	public List<PlanExecutionPlanOld> getOperations() {
		return operations;
	}

	public void setOperations(List<PlanExecutionPlanOld> operations) {
	...
	public List<PlanExecPlanDetailOld> getDetailNodes() {
		return detailNodes;
	}

	public void setDetailNodes(List<PlanExecPlanDetailOld> detailNodes) {
	...
	public List<PlanProjectNodeRelOld> getCtrlNodes() {
		return ctrlNodes;
	}

	public void setCtrlNodes(List<PlanProjectNodeRelOld> ctrlNodes) {
