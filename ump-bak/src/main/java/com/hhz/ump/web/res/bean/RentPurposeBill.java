...
//租赁合同/意向书审批表（由总部发起的申请）)	
public class RentPurposeBill extends BaseBidTemplate implements IStatusModifyListener {

//	发起方
	private String sendOrg1;//招商中心
	private String sendOrg2;//大客户中心
//	合同/意向书
	private String rentTypeCd1;//合同
	private String rentTypeCd2;//意见书
...
//	标准类型
	private String standardCd1;//标准
	private String standardCd2;//非标
...
//		11	其他事项		
	...
	public String getRentTypeCd1() {
		return rentTypeCd1;
	}
	public void setRentTypeCd1(String policyCd1) {
		this.rentTypeCd1 = policyCd1;
	}
	public String getRentTypeCd2() {
		return rentTypeCd2;
	}
	public void setRentTypeCd2(String policyCd2) {
		this.rentTypeCd2 = policyCd2;
	}
	...
	public String getStandardCd1() {
		return standardCd1;
	}
	public void setStandardCd1(String standardCd1) {
		this.standardCd1 = standardCd1;
	}
	public String getStandardCd2() {
		return standardCd2;
	}
	public void setStandardCd2(String standardCd2) {
		this.standardCd2 = standardCd2;
	}
	...
	public void statusModified(String oldStatuCd, String newStatuCd) throws Exception {
		...
		scContractTempletInfoManager.statusModified(oldStatuCd, newStatuCd, this.getResApproveInfoId(),
				this.getResApproveInfo().getDisplayNo(), this.getContractTempletInfoId(), "RentPurposeBill");
	}
