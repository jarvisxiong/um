 ...
 * 2012-7-10
 */
public class HrRenewContractApplyBlzb extends HrRenewContractApplyBase {
	...
	/**
	 * @return the positionGrade7
	 */
	public String getPositionGrade7() {
		return positionGrade7;
	}
	/**
	 * @param positionGrade7 the positionGrade7 to set
	 */
	public void setPositionGrade7(String positionGrade7) {
		this.positionGrade7 = positionGrade7;
	}
