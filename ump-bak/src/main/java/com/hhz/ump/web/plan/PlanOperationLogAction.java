 ...
 */
@Namespace("/plan")
public class PlanOperationLogAction extends CrudActionSupport<PlanOperationLog> {
	...
	private Page<PlanOperationLog> page = new Page<PlanOperationLog>(10);
	...
	public String log() throws Exception {
		...
		if (PlanOperationLogManager.MODULE_EXEC_PLAN.equals(moduleCd)
				|| PlanOperationLogManager.MODULE_PRE_PLAN.equals(moduleCd)) {
			projects = planMainManager.fetchAllProjects();
		} else if (PlanOperationLogManager.MODULE_COST_PLAN.equals(moduleCd)) {
	...
	private Map<String, String> buildOperatorMap(List<PlanOperationLog> result) {
		Map<String, String> m = new HashMap<String, String>();

		for (PlanOperationLog log : result) {
...
//		CollectionHelper.sortList(uaapOrgs, "orgBizCd");// 排序
	...
	private Map<String, String> buildOperationMap() {
		Map<String, String> m = new HashMap<String, String>();
		m.put(PlanOperationLogManager.OPERATION_TYPE_ADD, "新增");
		m.put(PlanOperationLogManager.OPERATION_TYPE_UPDATE, "更新");
		m.put(PlanOperationLogManager.OPERATION_TYPE_UPLOADATTACH, "上传附件");
		m.put(PlanOperationLogManager.OPERATION_TYPE_DELETEATTACH, "删除附件");
	...
	public PlanOperationLog getModel() {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Page<PlanOperationLog> getPage() {
		return page;
	}
