...
public class BidMeasureSupRelAction  extends CrudActionSupport<BidMeasureSupRel>{

	/**
	 * 
	 */
	private static final long serialVersionUID = 1465037562768953955L;

	@Autowired
	protected  BidMeasureSupRelManager bidMeasureSupRelManager;	
	private Page<BidMeasureSupRel> bidMeasureSupRelRs;	
	@Autowired
	...
	public String list() throws Exception {
		bidMeasureSupRelRs=new Page<BidMeasureSupRel>();
		...
		bidMeasureSupRelRs= bidMeasureSupRelManager.findPage(page, criterions);
		//搜索标段信息
	...
	@Override
	public BidMeasureSupRel getModel() {
		// TODO Auto-generated method stub
		return null;
	}

	public Page<BidMeasureSupRel> getBidMeasureSupRelRs() {
		return bidMeasureSupRelRs;
	}

	public void setBidMeasureSupRelRs(Page<BidMeasureSupRel> bidMeasureSupRelRs) {
		this.bidMeasureSupRelRs = bidMeasureSupRelRs;
	}
