...
public class BidLedgerManager extends BaseService<BidLedger, String> {
	 ...
	 * 共享服务器登录名
	 */
	private static final String SHARE_USER_NAME = "pd2pl";
	/**
	 * 共享服务器登录密码
	 */
	private static final String SHARE_PASSWORD = "pd2pl";
	/**
	 * 共享服务器所在域
	 */
	private static final String SHARE_DOMAIN = "powerDesk.com.cn";
	/**
	 * 共享服务器地址
	 */
	private static final String SHARE_IP = "192.168.173.180";
	/**
	 * 日志
	 */
...
//			SupContactor contactor = null;
	...
	public List findOrgList(String user){
		...
		List orgList = findBySql("select distinct t.project_cd   from POWERDESK.bid_project_role t where t.user_cd like '"+user+";%' or t.user_cd like '%;"+user+";%'", null);
		return orgList;
	}
