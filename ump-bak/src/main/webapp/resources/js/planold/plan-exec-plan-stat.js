	...
	function switchProject(srcElem, projectCd){
		...
		$.post(_ctx+'/planold/plan-exec-plan-stat!switchProject.action',data, function(result) {
	...
	function switchOperation(srcElem, projectCd, operationId){
		...
		var planTypeCd = getPlanTypeCd();
		var data = {projectCd: projectCd, operationId : operationId, planTypeCd: planTypeCd};
		$.post(_ctx + "/planold/plan-exec-plan-stat!switchOperation.action", data, function(result) {
	...
	function switchFullScreen(){
		var url = new Array();
		url.push(_ctx+'/planold/plan-exec-plan-stat!portal.action?');
