...
<body>
    <form id="login_form" action="http://192.168.180.237:9080/easportal/custom/eas.jsp" method="post" name="logonForm" autocomplete="off" runat="server">
	    <input type="hidden" id="usernumber" name="usernumber" value="<%= SpringSecurityUtils.getCurrentUiid()%>"/>
	    <input type="hidden" id="userencode" name="userencode" value="<%= userencode%>"/>
    </form>
