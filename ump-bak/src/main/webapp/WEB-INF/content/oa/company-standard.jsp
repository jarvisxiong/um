...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="${ctx}/resources/js/oa/companyStandard.js"></script>
		...
		<div class="title_bar" id="title_bar_banner">
			...
			<tr>
				<td>
					...
					<div class="fLeft" style="margin-top:5px;">
						<input type="checkbox" onchange="refreshFolderTree('${folderTreeTypeCd}')" style="margin-right:5px;" id="load_auto_flag" />自动刷新
					</div>
					</security:authorize>
