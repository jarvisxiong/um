...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="line-height: 25px;">
		<div class="moduleTtile">
			...
			<div style="float:left; height:29px;color:#5a5a5a;font-weight: bold;">&nbsp;商业招商汇报</div>
		</div>
		...
		<fieldset>
			<div>
				<div style="height: 35px;line-height:35px;background-color: #eeeeee">
					<div style="float:left;font-weight: bold;margin-right: 10px;font-size: 14px;color:#316685;padding-left:10px;">商业招商汇报</div>
				</div>
				<div>
					<table width="100%" cellpadding="0" cellspacing="0" class="editTable" style="margin:15px 0;">
						<security:authorize ifAnyGranted="A_SMS_SYKY_ADMIN">
						<tr>
						...
						<security:authorize ifAnyGranted="A_SMS_SYKY_USER">
						<tr>
							<td width="80px">短信内容：</td>
							<td width="620px" >
								<div class="content" id="msgContent">
									<% int i=1; %>
									<form action="${ctx}/oa/oa-send-msg!sendSyky.action" method="post" id="msgForm">
									<input type="hidden" name="smsModule" value="syky"/>
									商业
									...
									<input type="text" name="content<%=i++ %>" class="short"/>平方，合同
									<input type="text" name="content<%=i++ %>" class="short"/>%(目标
									<input type="text" name="content<%=i++ %>" class="short"/>%),新增
									<input type="text" name="content<%=i++ %>" class="short"/>平方,进场
									<input type="text" name="content<%=i++ %>" class="short"/>%,新增
									<input type="text" name="content<%=i++ %>" class="short"/>平方;
									<br/>
									</form>
								</div>
