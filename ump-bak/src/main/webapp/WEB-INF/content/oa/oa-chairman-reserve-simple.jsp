...
<div style="margin:0px 2px;">
	<table class="showTable" border="1" bordercolor="#BFC4C8" id="resRoomInfoTable">
		<thead>
			...
			<tr>
				<th align="center" style="padding-left:8px;">对象</th>
		...
		<s:iterator value="resMap" id="column">   
			...
			<s:if test="#total == 0">
				<tr class="mainTr">
					<td align="center">
						<label for="selectRoom_<s:property value='#column.key' />"><p:code2name mapCodeName="chairmanTypeMap" value="#column.key"/></label>
					</td>
