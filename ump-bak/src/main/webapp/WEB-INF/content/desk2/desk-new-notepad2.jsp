<%@ page contentType="text/html;charset=UTF-8" %>
 					<div style="width:94%;padding-bottom: 5px;height:22px;" class="font_title_16">
	 					<div style="float:left;">便签</div>
	 					<div class="div_clear"></div>
	 				</div>
	 				<div style="margin-top:8px;">
							<div class="content_left_page_selected">1</div>
							<div class="content_left_page">2</div>
							<div class="div_clear"></div>
					</div>
 					<div>
 						<div class="pd_notepad">
						...
						<div class="div_clear"></div>
 						<div class="block_deepblue_fast" style="width:154px;height:120px;margin-top: 4px;">
 						<div style="float:left;line-height: 35px;text-align: center;padding-left: 8px;">通知</div>
 						<div class="div_clear"></div>
 						</div>
