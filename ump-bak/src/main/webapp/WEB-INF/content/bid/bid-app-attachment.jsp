		...
		<fieldset style="padding:3px;">
		    ...
		    <div>
			    <div>
				    ...
				    <input type="hidden" name="fieldName" value="${bizFieldName}" />
		    ...
		    <table align="left" width="100%">
			    ...
			    <td width="10%">
					...
					<s:if test="userCd==#curUserCd">
								    		<a href="bid-app-attachment!delete.action?id=${appAttachFileId}&bizModuleCd=${bizModuleCd}&bizEntityId=${bizEntityId}&bizEntityName=${bizEntityName}&filterType=${filterType}&attachModelType=${attachModelType}&uiid=${uiid}">
...
<script type="text/javascript">
	...
	function submitAttachment(){
		...
		$("#mainForm").ajaxSubmit(function(result){
			...
			document.location = _ctx + "/bid/bid-app-attachment.action?bizModuleCd=${bizModuleCd}&bizEntityId=${bizEntityId}&filterType=${filterType}&bizEntityName=${bizEntityName}&attachModelType=${attachModelType}&uiid=${uiid}&bizFieldName=${bizFieldName}";
		});
	}
</script>
</body>
