...
<form action="${ctx}/bis/bis-tenant!merge.action" method="post" id="processForm">
...
<input type="hidden" name="imageBl" value="${imageBl}" />
...
<legend style="padding-left:10px;"><font style="font-weight:bolder; font-size:14px; color:#fb9032;">合并</font></legend>
	<div style="font-size:12px;padding-bottom:10px; line-height:30px;background-color:#F7F7F7">
	<table class="tb_noborder" style="width:95%;">
		...
		<tr>
			...
			<td colspan="5" style="padding-top: 10px;">
				<button type="button" class="btn_green" onclick="doMergeTenant();" >合并</button>
