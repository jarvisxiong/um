...
%>
	<div id="warp" >
	    <div id="header">
	     ...
	     <div class="form_body condition_panel clearfix" style="background: #E4E7EC;border-bottom: 1px solid #8C8F94;padding-left:10px;height:29px; ">
                        ...
                        <div style="text-align:right; margin-top:0px; border: 0px solid #cccccc; float: right;">
							  <span id="status" style="color:red; margin-right: 10px;font-size: 14px;height: 26px; padding-left:5px;line-height: 24px; font-style: normal;"></span>	
               			 	 <security:authorize ifAllGranted="A_BIS_MAIN_REJECT">
               			 			<button id="rejectReportBut" class="red"  style="width:76px; display:none; float: right;margin-right: 10px;" type="button">驳回周报</button>
	                       	 </security:authorize>
	                         <security:authorize ifAllGranted="A_BIS_MAIN_AFFIRM">
                            		<button id="affirmReportBut" class="green"  style="width:76px; display:none; float: right;margin-right: 10px;" type="button">确认周报</button>
            	    	  	 </security:authorize>
	                          <security:authorize ifAllGranted="A_BIS_MAIN_SUBMIT">
                           			<button id="submitReportBut" class="blue" style="width:76px; display:none; float: right; margin-right: 10px;" type="button">提交周报</button>
               			   	  </security:authorize>
               			   	  <security:authorize ifAllGranted="A_BIS_MAIN_NEW">
                         	  		<button id="addReportBut"   class="blue" style="width:76px; display:none; float: right;margin-right: 10px;"  type="button" >新增周报</button>
                        	  </security:authorize>
                        </div>
                </form>
	     </div>
