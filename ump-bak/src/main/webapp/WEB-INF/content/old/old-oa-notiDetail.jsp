			...
			<div id="container_outer">
				...
				<div id="container_inner">
					<div id="article_header">
						<h1>${notify.subjectme}</h1>
					</div>
					
					<div id="_article">
						<div class="hengxian"></div>
						<div id="newsInfo">
							发布于<s:property value="notify.sendTimet" />
						</div>
					
						<div id="article_content">
							<s:property value="notify.contentoun" escape="false" />
						</div>
						...
						<div id="article_attachment">
							<s:iterator value="mapAtta">
								<s:url id="showAttachment" action="downOld" namespace="/old">
									<s:param name="bizModuleCd">oldOaNotify</s:param>
