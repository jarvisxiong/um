...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(document).ready(function(){
			...
			$.post(
				'${ctx}/old/old-oa!queryNews.action',
				{
					'pageSize':lineCount,
					'pageNo':pageNo,
					'filter_LIKES_subject':title
				},
				function(result){
	...
	<body>
		<div class="title_bar search_bar_title">旧新闻</div>
		<div class="pagebody_c_border" >
			<s:form id="mainForm" action="old-oa!news.action" method="post">
				<s:hidden id="idPageNo" value="%{pageNews.pageNo}"></s:hidden>
				<div class="search_bar search_bar_condition_all">
					<div class="search_bar_condition_single" style="margin-buttom:6px;width:400px;padding:20px 10px;float:left;width:420px;">
						<span class="title">标题：</span><s:textfield name="filter_LIKES_subject" id="filterSubject" cssStyle="width:90%;" />
					</div>				
