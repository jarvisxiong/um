...
<div>
	<div class="left_log">
		...
		<div class="left_menu">
			<div  class="menu_click" >副总裁任务</div>
	...
	<div class="right_log">
		<form action="${ctx}/planold/plan-operation-log!log.action?moduleCd=ceoTask" id="mainForm" method="post">
			...
			<table class="showTable" >
				...
				<s:iterator value="page.result" status="status">
					...
					<tr>
						...
						<!--  <td>${bizEntityId}</td>-->
						<td class="ellipsisDiv" title='${operationLog}'>${modifiedObject}</td>
