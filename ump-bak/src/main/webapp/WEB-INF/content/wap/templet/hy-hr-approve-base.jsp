...
<%@page import="com.hhz.ump.util.CodeNameUtil"%>
	...
	<div class="div_row">
		...
		<div><s:checkbox name="templateBean.adjustItem1" cssClass="group"></s:checkbox><span>新聘</span></div>
		...
		<div><s:checkbox name="templateBean.adjustItem7" cssClass="group"></s:checkbox><span>奖励</span></div>
		<div><s:checkbox name="templateBean.adjustItem8" cssClass="group"></s:checkbox><span>处罚</span></div>
		<div><s:checkbox name="templateBean.adjustItem9" cssClass="group"></s:checkbox><span>辞退</span></div>
		<div><s:checkbox name="templateBean.adjustItem10" cssClass="group"></s:checkbox><span>其他:</span><span class="wap_value">${templateBean.adjustOther}</span></div>
	</div>
	<div class="div_label">
	<span class="wap_label">【调整内容详细】<red>(可左右拖动查看)</red></span>
	<div class="div_scroll">
		<table>
			...
			<tr>
			<td><span class="wap_title">工资(元)</span></td>
