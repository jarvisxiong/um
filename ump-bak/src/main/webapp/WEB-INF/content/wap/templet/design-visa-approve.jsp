...
<div id="billContent">
	...
	<div class="div_row">
		<div><s:checkbox name="templateBean.isThreeLine" cssClass="group"></s:checkbox><span>涉及园林景观、公共区域装修、精装修(销售楼盘)和“三点一线”(售楼处、样板房、景观示范区和看房通道)</span></div>
	</div>
	<div class="div_row">
		...
		<div><s:checkbox name="templateBean.tenantsHadVisa" cssClass="group"></s:checkbox><span>商户提出</span></div>
	</div>
	<div class="div_row">
	...
	<div class="div_row">
 			<span class="wap_title">原图纸编号:</span>
 			<span class="wap_value">${templateBean.drawingNo}</span>
 	</div>
 	<div class="div_row">
 	...
 	<div class="div_label">
 		...
 		<div class="div_row">
 			<span class="wap_title">拟签发设计变更图:</span>
