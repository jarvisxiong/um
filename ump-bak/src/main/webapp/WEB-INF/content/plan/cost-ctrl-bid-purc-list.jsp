...
<table class="content_table" id="result_table">
	...
	<tbody>
		<s:iterator value="dataMap" id="column" status="status">   
			<tr>
				<td colspan="10" style="padding-left:10px;" class="group-title">
			...
			<tr class="mainTr" id="main_${costCtrlBidPurcId}" 
				...
				<s:if test="planTypeCd == 2">
					style="color:green"
				</s:if>
				<s:if test="planTypeCd == 3">
					style="color:#0b96d2"
				</s:if>
			...
			>	
				<td click2expand="true">
					...
					<div class="cost-edit" style="display:none;">
						<img style="float:left;padding:5px;" src="${ctx}/resources/images/common/down_grey.gif">
				...
				<td onclick="changeOwner(this,'${costCtrlBidPurcId}')">
					<div>${ownerNames}</div>
					<input type="hidden" id="${costCtrlBidPurcId}UserNames" value="${ownerNames}"/>
						...
						<tr>
							...
							<td  style="border-bottom:1px solid #DCDCDE;">
								<div style="height:28px;padding-top:5px;padding-left:10px;">
									...
									<s:if test="pageType == 'con'">
										<!-- 合同管理确认完成权限 -->
										<security:authorize ifAnyGranted="A_CON_CONFIRM">
											<s:if test="scheduleStatusCd == 1">
											<!--<button class="btn_green_55_20" type="button" onclick="saveCost('${costCtrlBidPurcId}')">保存</button> -->
											<button class="btn_green_55_20" style="margin-right:5px;" type="button" onclick="conComplete('${costCtrlBidPurcId}')">完成</button>
									...
									<s:else>
										...
										<s:elseif test="scheduleStatusCd == 1">
											<security:authorize ifAnyGranted="A_BID_CONFIRM,A_BID_EDIT,A_BID_EDIT_SCHE">
										...
										<tr>
											<td style="padding-left:10px;">
												<input type="checkbox" onclick="changeWaitValue(this,'waitProjectDesc_${costCtrlBidPurcId}');" 
													...
													<security:authorize ifNotGranted="A_BID_EDIT,A_BID_EDIT_SCHE">
														disabled=disabled
													</security:authorize>
												/>
												...
												<tr>
													...
													<td>
														<input type="text" 
															...
															<security:authorize ifNotGranted="A_BID_EDIT,A_BID_CONFIRM">
															disabled=disabled
															</security:authorize>
													...
													<td style="padding-left:5px;">
														...
														<security:authorize ifAnyGranted="A_BID_EDIT,A_BID_EDIT_SCHE">
														<s:if test="pageType != 'con' && #s.last">
															disabled=diabled
														</s:if>
														<s:if test="pageType == 'con' && !#s.last">
															disabled=diabled
													    ...
													    <span id="spanSup_${costCtrlBidPurcId}">
															<s:if test="scheduleTypeName=='投标单位确认'">
															 <s:if test="isSuppCompleteFlag==1">
															        <img src="${ctx}/images/plan/pic_confirm.gif" title="已提供需求" 
															        <security:authorize ifAnyGranted="A_BID_EDIT,A_BID_EDIT_SCHE">
															        onclick="selectSuppliers('${costCtrlBidPurcId}')"
															        </security:authorize>
															        />
															 </s:if>
															 ...
															 <s:else>
															 	<security:authorize ifAnyGranted="A_BID_EDIT,A_BID_EDIT_SCHE">
															 	<button class="btn_green_55_20" type="button" onclick="selectSuppliers('${costCtrlBidPurcId}')">选择</button>
															 	</security:authorize>
															 </s:else>
															</s:if>
														</span>
...
<div align="right" style="padding-right:10px;margin-top:5px;">
