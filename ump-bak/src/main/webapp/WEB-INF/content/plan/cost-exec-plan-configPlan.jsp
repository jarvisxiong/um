...
<div id="configPlanContentDiv" style="padding-left:5px;">
	<table class="table_list" cellpadding="0" cellspacing="0" style="table-layout: fixed; width: 100%;">
		...
		<tbody>
			...
			<tr class="data">
				<td style="cursor: pointer;" onclick="enablePlanNameEdit('${costExecutionPlanId}');">
					<div id="${costExecutionPlanId}PlanNameDiv">${executionPlanName}</div>
					
					<input type="text" id="${costExecutionPlanId}PlanNameInput" 
						name="${costExecutionPlanId}PlanNameInput"
						value="${executionPlanName}"
						onblur="savePlanName('${costExecutionPlanId}');"
				...
				<td align="left">
					<img src="${ctx}/pics/companyvi/edit_file.gif" style="cursor: pointer;"
						...
						onclick="changePlanState('${costExecutionPlanId}', '${activeFlg}');"
					>
				</td>
				 --%>
			</tr>
