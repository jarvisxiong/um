	...
	<tbody>
		<s:iterator value="dataMap" id="column" status="status">   
			...
			<tr class="mainTr" group="group_<s:property value='#column.key'/>" id="main_${costCtrlBidPurcId}" 
				...
				<security:authorize ifAnyGranted="A_S_BP_EDIT">
				...
				<security:authorize ifNotGranted="A_S_BP_EDIT">
				...
				<security:authorize ifAnyGranted="A_S_BP_CONFIRM">
					<s:if test="scheduleStatusCd == 2">
						permConfirm="false"
					</s:if>
					<s:else>
				...
				<security:authorize ifNotGranted="A_S_BP_CONFIRM">
					permConfirm="false"
				</security:authorize>
			...
			>	
				...
				<td click2expand="true" class="pd-chill-tip" title="${serialType}${serialNo}">${serialType}${serialNo}
				<!-- 
							...
							<td  style="border-bottom:1px solid #DCDCDE;">
								<div style="height:28px;padding-top:5px;padding-left:10px;">
									...
									<s:if test="scheduleStatusCd == 0">
										<security:authorize ifAnyGranted="A_S_BP_CONFIRM,A_S_BP_EDIT">
									...
									<s:elseif test="scheduleStatusCd == 1">
										<security:authorize ifAnyGranted="A_S_BP_CONFIRM,A_S_BP_EDIT,A_S_BP_SCHE">
									...
									<s:if test="scheduleStatusCd == 0 ||scheduleStatusCd == 1">
										<security:authorize ifAnyGranted="A_S_BP_DELETE">
								    ...
								    <s:if test="resApproveId!=null">
							            <div onclick="parent.showAll('${ctx}/res/res-approve-info.action?id=${resApproveId}','resApprove');" style="float:left;padding-left:10px;cursor: pointer; text-decoration: underline;">定标审批表</div>
					    	        </s:if>
								</div>
							</td>
						</tr>
										...
										<tr>
											<td style="padding-left:10px;">
												<input type="checkbox" onclick="changeWaitValue(this,'waitProjectDesc_${costCtrlBidPurcId}');" 
													...
													<security:authorize ifNotGranted="A_S_BP_EDIT,A_S_BP_SCHE">
														disabled=disabled
													</security:authorize>
												/>
											  ...
											  <s:if test="!(dataTypeCd == 0&&(scheduleTypeCd == 4||scheduleTypeCd ==5))" >
												...
												>
													...
													<td>
														<input type="text" 
															...
															<s:if test="scheduleTypeName == '定标'">
																...
																<s:else>
																	<security:authorize ifAnyGranted="A_S_BP_SCHE">
																		disabled=disabled
																	</security:authorize>
																</s:else>
															</s:if>
															<s:else>
																<security:authorize ifNotGranted="A_S_BP_EDIT,A_S_BP_CONFIRM,A_S_BP_SCHE">
																	disabled=disabled
																</security:authorize>
															</s:else>
														/>
													...
													<td style="padding-left:5px;">
														...
														<security:authorize ifAnyGranted="A_S_BP_EDIT,A_S_BP_SCHE">
															<s:if test="#s.last">
																disabled=diabled
															</s:if>
														</security:authorize>
