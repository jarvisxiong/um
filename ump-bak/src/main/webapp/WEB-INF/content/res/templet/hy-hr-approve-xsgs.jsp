	...
	<form action="res-approve-info!save.action" method="post" id="templetForm">
		<table  class="mainTable" style="margin-bottom: 5px;">
			...
			<table class="tb_checkbox">
				...
				<td><s:checkbox name="templateBean.positionLevel2" cssClass="group"></s:checkbox>副总经理级(财务人员除外)</td>
				</tr>
				<tr>
				<td><s:checkbox name="templateBean.positionLevel3" cssClass="group"></s:checkbox>财务人员：副总经理级或财务负责人</td>
				<td><s:checkbox name="templateBean.positionLevel4" cssClass="group"></s:checkbox>财务人员：经理级</td>
				</tr>
				<tr>
				<td><s:checkbox name="templateBean.positionLevel6" cssClass="group"></s:checkbox>财务人员：经理级以下</td>
