	...
	<table class="mainTable" style="margin-bottom: 5px;">
		...
		<col />
			...
			<tr>
				...
				<td align="left">
					<input class="inputBorder Wdate" validate="required" type="text" name="templateBean.filingDate" value="${templateBean.filingDate}" onfocus="WdatePicker()" style="width:200px;"/>
				</td>
			</tr>
	</table>
