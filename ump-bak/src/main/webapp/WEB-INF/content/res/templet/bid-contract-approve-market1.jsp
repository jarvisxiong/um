	...
	<form action="res-approve-info!save.action" method="post" id="templetForm" class="contractPaymentBill">
		...
		<table  class="mainTable">
			...
			<tr>
				...
				<td>
				<input class="inputBorder" validate="required" type="text" id="engineeringName" name="templateBean.engineeringName" value="${templateBean.engineeringName}" />
				</td>
			</tr>
			<tr>
			...
			<tr otype="attach">
				<td style="height:40px;" value="${templateBean.bidApproveBillId}" resattachname="定标审批表">定标审批表</td>
				<td>
				<s:if test="#canEdit=='true'">
