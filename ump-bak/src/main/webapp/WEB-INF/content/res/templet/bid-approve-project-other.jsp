	...
	<form action="res-approve-info!save.action" method="post" id="templetForm" class="contractPaymentBill">
		...
		<table  class="mainTable">
			...
			<tr>
				...
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.bidQualificationApproveId}" resattachname="邀标单位资质审批表">1、邀标单位资质审批表</td>
				<td align="center">
			...
			<tr>
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.bidPriceListId}" resattachname="中标单位报价清单">2、中标单位报价清单</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
			...
			<tr>
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.bidSummaryId}" resattachname="投标报价汇总表">3、投标报价汇总表</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
			...
			<tr>
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.bidAnswerAndBidQueryId}" resattachname="招标答疑及询标问卷">4、招标答疑及询标问卷</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
			...
			<tr>
				<td class="require" align="center" style="height:40px;" validate="required" value="${templateBean.techBidEvaluateId}" resattachname="技术标评结果">5、技术标评结果</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
			...
			<tr>
				<td align="center" style="height:40px;" value="${templateBean.bidPictrueId}" resattachname="招标图纸">
				6、招标图纸
				</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
				<input type="button" value="上传附件" class="btn_green_65_20" style="border:none;" onclick="showUploadSingleAttachDialog('招标图纸','${resApproveInfoId==null?entityTmpId:resApproveInfoId}','resCustomFile','bidPictrueId',event);"/>
			...
			<tr>
				...
				<td class="td_title">
				  <div   class="btn_green"  title="把当前定标审批表导入到合同文本库" onclick="doImportContLib('${resApproveInfoId}');" style="width:110px;">导入合同文本库</div>
			   </td>
				<td>
					  创建合同文本库后系统会自动创建合同台账！
