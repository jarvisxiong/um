...
<div align="center" class="billContent">
	...
	<form action="res-approve-info!save.action" method="post" id="templetForm" class="contractPaymentBill">
		...
		<table class="mainTable">
			...
			<tr>
				<td class="td_title">结算总价(含甲供料)</td>
				<td colspan="3">
				<input class="inputBorder" validate="required" type="text" name="templateBean.fuClearPrice" value="${templateBean.fuClearPrice}" onblur="formatVal($(this));"/>
				</td>
			</tr>
			<tr>
				<td class="td_title">预留：质保金</td>
				<td colspan="3">
				<input class="inputBorder" validate="required" type="text" name="templateBean.fuGuaranteeMoney" value="${templateBean.fuGuaranteeMoney}" onblur="formatVal($(this));"/>
				</td>
			</tr>
			<tr>
				<td class="td_title">扣：甲供料款(按暂定价)</td>
				<td colspan="3">
				<input class="inputBorder" validate="required" type="text" name="templateBean.fuMatieralPrice" value="${templateBean.fuMatieralPrice}" onblur="formatVal($(this));"/>
				</td>
			</tr>
			<tr>
				<td class="td_title">扣：已直接付款累计</td>
				<td colspan="3">
				<input class="inputBorder" validate="required" type="text" name="templateBean.fuCurrentPay" value="${templateBean.fuCurrentPay}" onblur="formatVal($(this));"/>
				</td>
			</tr>
			<tr>
				<td class="td_title">扣：其他扣款或代付款累计</td>
				<td colspan="3">
				<input class="inputBorder" validate="required" type="text" name="templateBean.fuCurrentAdd" value="${templateBean.fuCurrentAdd}" onblur="formatVal($(this));"/>
				</td>
			</tr>
			<tr>
				<td class="td_title">本次付款金额</td>
				<td colspan="3">
				<input class="inputBorder" validate="required" type="text" name="templateBean.fuPayMoney" value="${templateBean.fuPayMoney}" onblur="formatVal($(this));"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="center" style="height:40px;" validate="required" value="${templateBean.proSettleId}">工程结算审批表</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
				<input type="button" value="上传附件" class="btn_green_65_20" style="border:none;" onclick="showUploadSingleAttachDialog('工程结算审批表','${resApproveInfoId==null?entityTmpId:resApproveInfoId}','resCustomFile','proSettleId',event);"/>
				<input type="hidden" name="templateBean.proSettleId" id="proSettleId" value="${templateBean.proSettleId}"/>
				</s:if>
				</td>
				<td>
