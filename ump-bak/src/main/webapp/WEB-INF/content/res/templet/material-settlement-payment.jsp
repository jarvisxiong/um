	...
	<form action="res-approve-info!save.action" method="post" id="templetForm" class="contractPaymentBill">
		...
		<table class="mainTable">
			...
			<tr>
				...
				<td align="center" style="height:40px;" validate="required" value="${templateBean.materialSettlementApproveId}">材料设备结算审批表</td>
				<td align="center">
				<s:if test="#canEdit=='true'">
				<input type="button" value="上传附件" class="btn_green_65_20" style="border:none;" onclick="showUploadSingleAttachDialog('材料设备结算审批表','${resApproveInfoId==null?entityTmpId:resApproveInfoId}','resCustomFile','materialSettlementApproveId',event);"/>
				<input type="hidden" name="templateBean.materialSettlementApproveId" id="materialSettlementApproveId" value="${templateBean.materialSettlementApproveId}"/>
				</s:if>
				</td>
				<td>
