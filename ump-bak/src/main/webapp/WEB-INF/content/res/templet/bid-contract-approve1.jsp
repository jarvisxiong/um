		...
		<table  class="mainTable">
			...
			<tr>
				...
				<td colspan="3" class="chkGroup" align="left"  validate="required">
					...
					<col width="150">
					<tr>
					<td><s:checkbox name="templateBean.businessCompany" id="businessCompany" cssClass="group"></s:checkbox>总部发起</td>
					<td><s:checkbox name="templateBean.businessGroup" id="businessGroup" cssClass="group"></s:checkbox>地产公司发起</td>
					</tr>
					</table>
				</td>
			</tr>
			</s:if>
			<s:if test="authTypeCd=='JD_ZCGL_HTQS_20'||authTypeCd=='JD_ZCGL_HTQS_40'||
			authTypeCd=='JD_ZCGL_HTQS_50'||authTypeCd=='JD_ZCGL_HTQS_60'||authTypeCd=='JD_ZCGL_HTQS_70'||authTypeCd=='JD_ZCGL_HTQS_80'
			 || authTypeCd == 'SYGS_ZCGL_HTQS_10' || authTypeCd == 'BLSY_ZCGL_HTQS_10' || authTypeCd == 'ZCGL_HTQS_61'
			">
			<tr>
				<td class="td_title require"></td>
				<td colspan="3" class="chkGroup" align="left"  validate="required">
			...
			<tr>
				...
				<td colspan="3" style="padding-top:3px;">
					<table border="0" cellpadding="0" cellspacing="0" class="tb_noborder">
						...
						<td>招标范围:</td>
						<td>
						<input class="inputBorder" validate="required" id="bidRange" type="text" name="templateBean.bidRange" value="${templateBean.bidRange}" />
						</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td colspan="3" style="padding-top:3px;">
					<table border="0" cellpadding="0" cellspacing="0" class="tb_noborder">
						...
						<td>预算金额(元):</td>
						<td>
						<input class="inputBorder" id="budgetAmount" validate="required" type="text" name="templateBean.budgetAmount" value="${templateBean.budgetAmount}" onblur="formatVal($(this));" />
						</td>
						</tr>
					</table>
				</td>
...
var mapPrama={
		...
		bidApprNoFromCont:'bidApprNoFromCont'
	};
<s:if test="authTypeCd=='ZCGL_HTQS_10'||authTypeCd=='ZCGL_HTQS_12'">
var param={isAudit:'noAudit',codeType:'0'};
</s:if>
<s:elseif test="authTypeCd=='JD_ZCGL_HTQS_20'||authTypeCd=='JD_ZCGL_HTQS_40'||authTypeCd=='JD_ZCGL_HTQS_60'||authTypeCd=='JD_ZCGL_HTQS_80'">
var param={isAudit:'noAudit',codeType:'3'};
</s:elseif>
<s:else>
