				...
				<td colspan="6" style="padding-right: 0px; padding-left: 0px; ">
					<table id="tbConItem" border="1px solid #8c8f94;" cellpadding="0" cellspacing="0" frame="void" style="width: 100%; border-collapse:collapse;" >
						...
						<tr id="trConItem" style="display: none;margin-bottom:5px;">
							<td><s:select cssClass="inputBorder" validate="required" list="@com.powerlong.org.pd.util.DictMapUtil@getMapHolidayType()" listKey="key" listValue="value" name="templateBean.otherProperties[0].holidayType" id="holidayType0" onchange="selectHolidayType(this);"></s:select></td>
							<td>
							...
							<td><input onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH'})" class="Wdate inputBorder" type="text" name="templateBean.otherProperties[0].beginDate" id="beginDate0" onchange="countTotalDays(this);" /></td>
							<td><input onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH'})" class="Wdate inputBorder" type="text" name="templateBean.otherProperties[0].endDate" id="endDate0" onchange="countTotalDays(this);" /></td>
...
<script type="text/javascript">
	...
	function addItem(){
		...
		//	$(".thConItem").removeAttr("validate");
		//	$(".thConItem").removeAttr("title");
		//	$(".thConItem").removeClass("error");
		//}
	}
	function delItem(dom){
		...
		//if($("#tbConItem tr").size() == 1) {
		//	$(".thConItem").attr("validate","required");
		//}
	}
</script>
<s:if test="resApproveInfoId==null">
