...
<% if (index!=null){ %>
<input style="${style}" class="inputBorder" <% if (isRequired==null || isRequired.equals("true")){ %>validate="required" <%} %> type="text" name="templateBean.${subProp}[${index}].${name}" value="${value}"/>
<%}else{ %>
<input style="${style}" class="inputBorder" <% if (isRequired==null || isRequired.equals("true")){ %>validate="required" <%} %> type="text" name="templateBean.${name}" value="${value}"/>
<%} %>