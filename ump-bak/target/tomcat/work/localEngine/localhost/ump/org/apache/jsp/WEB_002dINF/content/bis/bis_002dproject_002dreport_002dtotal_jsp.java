...
public final class bis_002dproject_002dreport_002dtotal_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	response.setDateHeader("Expires", 0);
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div id=\"projRptDetail\"></div>\r\n");
      out.write("\r\n");
      out.write("<div style=\"margin-top: 10px; float: left;\" id=\"buttons_group\">\r\n");
      out.write("    <input type=\"button\" value=\"查看本项目费用\" class=\"btn_blue\" style=\"width:105px; font-size:12px;\"\r\n");
      out.write("           onclick=\"viewFeeManage();\"/>\r\n");
      out.write("    <input type=\"button\" value=\"查看本项目合同\" class=\"btn_green\" style=\"width:105px; font-size:12px;\"\r\n");
      out.write("           onclick=\"viewContManage();\"/>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<div id=\"projDebtPanel\" style=\"border:0px solid #cccccc;\">\r\n");
      out.write("    ");
      out.write("\r\n");
      out.write("</div>\r\n");
      ...
      out.write("    function loadReportDetail() {\r\n");
      out.write("        var data = {\r\n");
      ...
      out.write("/bis/bis-project-report!loadReportDetail.action\";\r\n");
      out.write("        $.post(url, data, function (result) {\r\n");
      out.write("            $(\"#projRptDetail\").html(result);\r\n");
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function loadProjectDebt() {\r\n");
      out.write("        var url = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/bis/bis-project-report!loadProjectDebt.action\";\r\n");
      out.write("        $.post(url, {bisProjectId:$(\"#bisProjectId\").val()}, function (result) {\r\n");
      out.write("            $(\"#projDebtPanel\").html(result);\r\n");
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_security_005fauthorize_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/bis/bis-project-report-total.jsp(528,0) name = ifAnyGranted type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_security_005fauthorize_005f0.setIfAnyGranted("A_REPO_PROJ_QUERY");
    int _jspx_eval_security_005fauthorize_005f0 = _jspx_th_security_005fauthorize_005f0.doStartTag();
    if (_jspx_eval_security_005fauthorize_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("    <script type=\"text/javascript\">\r\n");
        out.write("        if (location.href.indexOf(\"debt\") == -1) {\r\n");
        out.write("            loadReportDetail();\r\n");
        out.write("        }\r\n");
        out.write("    </script>\r\n");
  ...
  private boolean _jspx_meth_security_005fauthorize_005f1(PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/bis/bis-project-report-total.jsp(536,0) name = ifAnyGranted type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_security_005fauthorize_005f1.setIfAnyGranted("A_REPO_ARRE_QUERY");
    int _jspx_eval_security_005fauthorize_005f1 = _jspx_th_security_005fauthorize_005f1.doStartTag();
    if (_jspx_eval_security_005fauthorize_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("    <script type=\"text/javascript\">\r\n");
        out.write("        //loadProjectDebt();\r\n");
        out.write("        if (location.href.indexOf(\"debt\") != -1) {\r\n");
        out.write("            $(\"#buttons_group\").hide();\r\n");
        out.write("            loadProjectDebt();\r\n");
        out.write("        }\r\n");
        out.write("    </script>\r\n");
