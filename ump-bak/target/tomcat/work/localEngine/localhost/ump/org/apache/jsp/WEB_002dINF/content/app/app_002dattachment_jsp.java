...
public final class app_002dattachment_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<fieldset style=\"padding:3px;\">\r\n");
      out.write("\t\t    <legend>");
      ...
      // /WEB-INF/content/app/app-attachment.jsp(59,7) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_s_005fiterator_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          out.write("\t\t\t    \t<!-- 如果是共享人,则不允许删除;否则,可删除 -->\r\n");
          out.write("\t\t\t\t\t");
          ...
          // /WEB-INF/content/app/app-attachment.jsp(79,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          _jspx_th_s_005fset_005f2.setVar("curUser");
      ...
      out.write("\t\t    </div>\r\n");
      out.write("\t\t</fieldset>\r\n");
      out.write("<!--\t\t<input type=\"button\" value=\"完成\"  class=\"btn_green_55_20\" style=\"border:none;\" onclick=\"doClose();\" />-->\r\n");
      out.write("\t</div>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\tfunction doClose(){\r\n");
      out.write("\t\tymPrompt.close();\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction addNewFile() {\r\n");
      out.write("\t\tvar trUpload = $(\"#trUpload\").clone();\r\n");
      out.write("\t\ttrUpload.appendTo(\"#downTable\");\r\n");
      out.write("\t\ttrUpload.append(\"<td onclick='remove(this);' style='cursor: pointer;'><font style='color:red;font-weight:bold;cursor:pointer;'>×</font></td>\");\r\n");
      out.write("\t\t//$(\"#file\").click();\r\n");
      out.write("\t\t//$(\"#upload\").css(\"display\",\"block\");\r\n");
      out.write("\t\t//$(\"#upload\").attr(\"id\",\"\");\r\n");
      out.write("\t\t//$(\"#trUpload\").css(\"display\",\"block\");\r\n");
      out.write("\t\t//$(\"#trUpload\").attr(\"id\",\"\");\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction remove(dom){\r\n");
      out.write("\t\t$(dom).parent().remove();\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction submitAttachment(){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif($(\"#mainForm\").find(\"input[name='bizModuleCd']\").val() == 'resContract'){ \r\n");
      out.write("\t\t\tvar fileName = \t$(\"#file\").val();\r\n");
      out.write("\t\t    var suffix = fileName.substring(fileName.lastIndexOf('.')+1,fileName.length).toLowerCase();\r\n");
      out.write("\t\t    if( suffix!= 'docx'){\r\n");
      out.write("\t\t\t\talert(\"请上传2007版word格式合同文件,谢谢!\");\r\n");
      ...
      out.write("\t\t} \r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#tipUploadPorcess\").show();\r\n");
      out.write("\t\t$(\"#operationUploadDiv\").hide();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#mainForm\").ajaxSubmit(function(result){\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$(\"#tipUploadPorcess\").hide();\r\n");
      out.write("\t\t\t$(\"#operationUploadDiv\").show();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(result.indexOf(\"maxSizeError\") == 0){\r\n");
      out.write("\t\t\t\tvar max = result.split(\"-\")[1];\r\n");
      out.write("\t\t\t\talert(\"上传文件最大不能超过 \" + max + \" M\");\r\n");
      out.write("\t\t\t\t//ymPrompt.alert({message:'上传文件最大不能超过'+max+'M',title:\"提示\",width:260,height:180});\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tif(result.indexOf(\"cantUploadType\") == 0){\r\n");
      out.write("\t\t\t\tvar tmpType = result.split(\"-\")[1];\r\n");
      out.write("\t\t\t\talert(\"无法上传文件： \" + tmpType);\r\n");
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tdocument.location = _ctx + \"/app/app-attachment.action?bizModuleCd=");
      ...
      out.write("&bizEntityName=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${bizEntityName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("&attachModelType=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${attachModelType}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("&uiid=");
      ...
      out.write("&bizFieldName=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${bizFieldName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\";\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_s_005fform_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(23,1) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setId("mainForm");
    // /WEB-INF/content/app/app-attachment.jsp(23,1) name = action type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setAction("app-attachment!upload");
    // /WEB-INF/content/app/app-attachment.jsp(23,1) name = method type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fform_005f0.setMethod("post");
    // /WEB-INF/content/app/app-attachment.jsp(23,1) name = enctype type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_s_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t<div id=\"tipUploadPorcess\" style=\"display:none;width:100%;color:red;text-align: center;\">正在上传中...</div>\r\n");
        out.write("\t<div id=\"operationUploadDiv\" style=\"padding:3px;\">\r\n");
        out.write("\t\t<fieldset style=\"padding:3px;\">\r\n");
        out.write("\t\t    <legend>");
        ...
        out.write("\t\t    <div>\r\n");
        out.write("\t\t\t    <div>\r\n");
        out.write("\t\t\t\t    <input type=\"hidden\" name=\"bizModuleCd\" value=\"");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${bizModuleCd}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\" />\r\n");
        ...
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${filterType}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\" />\r\n");
        out.write("\t\t\t\t    <input type=\"hidden\" name=\"bizEntityName\" value=\"");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${bizEntityName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\" />\r\n");
        out.write("\t\t\t\t    <input type=\"hidden\" name=\"attachModelType\" value=\"");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${attachModelType}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\" />\r\n");
        out.write("\t\t\t\t    <input type=\"hidden\" name=\"uiid\" value=\"");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${uiid}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\" />\r\n");
        out.write("\t\t\t\t    <input type=\"hidden\" name=\"bizFieldName\" value=\"");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${bizFieldName}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\" />\r\n");
        out.write("\t\t\t\t    <table id=\"downTable\" class=\"editTable\"  >\r\n");
        out.write("\t\t\t\t    \t<tr id=\"trUpload\">\r\n");
        out.write("\t\t\t\t    \t<td><input type=\"file\" id=\"file\" style=\"line-height:22px;height:22px;margin-bottom:3px;\" name=\"upload\"/></td></tr>\r\n");
        out.write("\t\t\t\t    </table>\r\n");
        out.write("\t\t\t    </div>\r\n");
        out.write("\t\t\t    <div>\r\n");
        out.write("\t\t\t     \t<!-- 默认允许多个上传 -->\r\n");
        ...
        if (_jspx_meth_s_005fif_005f0(_jspx_th_s_005fform_005f0, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("\t\t\t\t    <input class=\"btn_green\" type=\"button\" value=\"");
        if (_jspx_meth_s_005ftext_005f2(_jspx_th_s_005fform_005f0, _jspx_page_context))
          return true;
        out.write("\" onclick=\"submitAttachment()\"/>\r\n");
        out.write("\t\t\t    </div>\r\n");
        out.write("\t\t    </div>\r\n");
        out.write("\t\t</fieldset>\r\n");
        out.write("\t</div>\r\n");
  ...
  private boolean _jspx_meth_s_005ftext_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(27,14) name = name type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftext_005f0.setName("common.upload");
  ...
  private boolean _jspx_meth_s_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(44,8) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fif_005f0.setTest("attachModelType == null || attachModelType == ''");
    ...
    if (_jspx_eval_s_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t\t\t   \t \t<input class=\"btn_green\" onclick=\"addNewFile();\" type=\"button\" value=\"");
  ...
  private boolean _jspx_meth_s_005ftext_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fif_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(45,80) name = name type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftext_005f1.setName("appAttachment.add");
  ...
  private boolean _jspx_meth_s_005ftext_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fform_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(47,54) name = name type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftext_005f2.setName("common.upload");
  ...
  private boolean _jspx_meth_s_005ftext_005f3(PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(56,14) name = name type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftext_005f3.setName("common.download");
  ...
  private boolean _jspx_meth_s_005furl_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(62,8) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005furl_005f0.setId("down");
    // /WEB-INF/content/app/app-attachment.jsp(62,8) name = action type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005furl_005f0.setAction("download");
    // /WEB-INF/content/app/app-attachment.jsp(62,8) name = namespace type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fparam_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005furl_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(63,9) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fparam_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005furl_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(64,9) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fparam_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005furl_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(65,9) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fparam_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005furl_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(66,9) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fparam_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005furl_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(67,9) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fproperty_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(73,8) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fset_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(77,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fset_005f0.setVar("entityId");
    // /WEB-INF/content/app/app-attachment.jsp(77,5) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fset_005f0.setValue("bizEntityId");
  ...
  private boolean _jspx_meth_s_005fset_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(78,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fset_005f1.setVar("isSharedUser");
    // /WEB-INF/content/app/app-attachment.jsp(78,5) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fset_005f1.setValue("%{isSharedUser(#entityId)}");
  ...
  private boolean _jspx_meth_s_005fif_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /WEB-INF/content/app/app-attachment.jsp(80,5) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fif_005f1.setTest("userCd==#curUserCd");
    ...
    if (_jspx_eval_s_005fif_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t\t\t<a href=\"app-attachment!delete.action?id=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${appAttachFileId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("&bizModuleCd=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${bizModuleCd}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("&bizEntityId=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${bizEntityId}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("&bizEntityName=");
        ...
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${uiid}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\">\r\n");
        out.write("\t\t\t    \t\t\t<font style='color:red;font-weight:bold;cursor:pointer;'>×</font></a>\r\n");
        out.write("\t\t\t\t\t");
