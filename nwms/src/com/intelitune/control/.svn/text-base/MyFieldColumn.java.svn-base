 ...
 */
public class MyFieldColumn extends MyColumn {
     ...
     */
    public MyFieldColumn(String name) {
        super(name);
    }
     ...
     */
    public MyFieldColumn(String name, Field field) {
        super(name);
        if (field == null) {
     ...
     */
    public MyFieldColumn(String name, String title) {
        super(name, title);
    }
     ...
     * @param field the field to process and render
     */
    public MyFieldColumn(String name, String title, Field field) {
        super(name, title);
        if (field == null) {
            throw new IllegalArgumentException("Null field parameter");
        }
