 ...
 * @see com.intelitune.nwms.model.Customer
 * @author Hibernate Tools
 */
public class CustomerHome {
	
	private final static CustomerHome instance = new CustomerHome();

	private CustomerHome() {
	}

	public static final CustomerHome getInstance() {
		return instance;
	}
	...
	public Customer findById(java.lang.Integer id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession()
					.get("com.intelitune.nwms.model.Customer", id);
			if (instance == null) {
		...
		try {
			List<Customer> results = (List<Customer>) sessionFactory
					.getCurrentSession().createCriteria(
							"com.intelitune.nwms.model.Customer").add(
	...
	public List<Customer> findAll(){
		...
		List<Customer> list=sessionFactory.getCurrentSession().createQuery(hql).list();
		return list;
	}
