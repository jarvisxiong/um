...
public class UpdateResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the out value for this UpdateResponse.
     * 
     * @return out
     */
    ...
    /**
     * Sets the out value for this UpdateResponse.
     * 
     * @param out
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://com/intelitune/ccos/client", ">updateResponse"));
