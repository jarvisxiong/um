...
public class Update  implements java.io.Serializable {
    ...
    /**
     * Gets the in0 value for this Update.
     * 
     * @return in0
     */
    ...
    /**
     * Sets the in0 value for this Update.
     * 
     * @param in0
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://com/intelitune/ccos/client", ">update"));
