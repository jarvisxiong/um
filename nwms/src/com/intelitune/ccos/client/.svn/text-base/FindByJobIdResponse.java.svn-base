...
public class FindByJobIdResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the out value for this FindByJobIdResponse.
     * 
     * @return out
     */
    ...
    /**
     * Sets the out value for this FindByJobIdResponse.
     * 
     * @param out
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FindByJobIdResponse)) return false;
        FindByJobIdResponse other = (FindByJobIdResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FindByJobIdResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://com/intelitune/ccos/client", ">findByJobIdResponse"));
