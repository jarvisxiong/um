...
public class FindByIdResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the out value for this FindByIdResponse.
     * 
     * @return out
     */
    ...
    /**
     * Sets the out value for this FindByIdResponse.
     * 
     * @param out
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://com/intelitune/ccos/client", ">findByIdResponse"));
